  ...
  for reference in ['%s%d'%(ELEM[Z],A)]:
    ...
    for e in [12]:
      for hw in [16]:
        ...
        # Look for the existing Magnus operators
        ...
        jobname  = '%s_Kumar_%s_e%s_E%s_s%s_hw%s' %(ARGS['valence_space'],intlabel,ARGS['emax'],ARGS['e3max'],ARGS['smax'],ARGS['hw'])
