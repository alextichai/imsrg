...
#     ARGS['3bme'] = '/data_share11/takayuki/me3j/NO2B_ThBME_EM1.8_2.0_3NFJmax15_IS_hw%i_ms18_36_24.stream.bin'%(hw)    
        ...
        ARGS['2bme'] = '/Users/alexandertichai/Work/Matrixelements/ME2J/TwBME-HO_NN-only_N3LO_EM500_srg1.8_hw%i_emax14_e2max28.me2j.gz'%(hw)
        ARGS['3bme'] = '/Users/alexandertichai/Work/Matrixelements/ME3J/NO2B_ThBME_EM1.8_2.0_3NFJmax15_JJmax15_IS_hw%i_ms18_36_24.stream.bin'%(hw)    
    #  ARGS['3bme'] = 'none'
        ARGS['LECs'] = 'EM_1.8_2.0'
        ARGS['3bme_type'] = 'no2b'
