...
//   void Store_Darmstadt_3body( std::vector<float>& ThreeBME, Operator& Hbare, int E1max, int E2max, int E3max);
   ...
   void Write_me2j_np( std::string filename, Operator& op, int emax, int e2max, int lmax);
   ...
   void Write_nat_occs_to_me1j(std::string filename, Operator &op, int emax, int lmax);
   void Write_ref_occs_to_me1j(std::string filename, Operator &op, int emax, int lmax);
