...
Operator OperatorFromString(ModelSpace& modelspace, std::string opname) {
  ...
  Operator theop;
  std::vector<std::string> opnamesplit = split_string(
      opname, "_");  // split std::string on _ into a vector of std::string so
                     // that, e.g. "R2_p1"  =>  {"R2", "p1"}

  if (opname == "R2_p1")
    theop = R2_1body_Op(modelspace, "proton");
  else if (opname == "R2_p2")
    theop = R2_2body_Op(modelspace, "proton");
  else if (opname == "R2_n1")
    theop = R2_1body_Op(modelspace, "neutron");
  else if (opname == "R2_n2")
    theop = R2_2body_Op(modelspace, "neutron");
  else if (opname == "Rp2")
    theop = Rp2_corrected_Op(modelspace, modelspace.GetTargetMass(),
                             modelspace.GetTargetZ());
  else if (opname == "Rn2")
    theop = Rn2_corrected_Op(modelspace, modelspace.GetTargetMass(),
                             modelspace.GetTargetZ());
  else if (opname == "Rm2")
    theop = Rm2_corrected_Op(modelspace, modelspace.GetTargetMass(),
                             modelspace.GetTargetZ());
  else if (opname == "Rm2lab")
    theop = RSquaredOp(modelspace);
  else if (opname == "ISM")
    theop = MultipoleResponseOp(
        modelspace, 2,
        0);  // Isoscalar monopole (see PRC97(2018)054306 ) --added by bhu
  else if (opname == "ISQ")
    theop = MultipoleResponseOp(
        modelspace, 2,
        2);  // Isoscalar quadrupole (see PRC97(2018)054306 ) --added by bhu
  else if (opname == "IVD")
    theop = IVDipoleOp(
        modelspace, 1,
        1);  // Isovector dipole (see PRC97(2018)054306 ) --added by bhu
  else if (opname == "E1")
    theop = ElectricMultipoleOp(modelspace, 1);
  else if (opname == "E2")
    theop = ElectricMultipoleOp(modelspace, 2);
  else if (opname == "E3")
    theop = ElectricMultipoleOp(modelspace, 3);
  else if (opname == "E4")
    theop = ElectricMultipoleOp(modelspace, 4);
  else if (opname == "E5")
    theop = ElectricMultipoleOp(modelspace, 5);
  else if (opname == "E6")
    theop = ElectricMultipoleOp(modelspace, 6);
  else if (opname == "E2int")
    theop = IntrinsicElectricMultipoleOp(modelspace, 2);  // Untested
  else if (opname == "nE2")
    theop = NeutronElectricMultipoleOp(modelspace, 2);
  else if (opname == "M1")
    theop = MagneticMultipoleOp(modelspace, 1);
  else if (opname == "M2")
    theop = MagneticMultipoleOp(modelspace, 2);
  else if (opname == "M3")
    theop = MagneticMultipoleOp(modelspace, 3);
  else if (opname == "M4")
    theop = MagneticMultipoleOp(modelspace, 4);
  else if (opname == "M5")
    theop = MagneticMultipoleOp(modelspace, 5);
  else if (opname == "M1p")
    theop = MagneticMultipoleOp_pn(modelspace, 1, "proton");
  else if (opname == "M1n")
    theop = MagneticMultipoleOp_pn(modelspace, 1, "neutron");
  else if (opname == "M1S")
    theop = MagneticMultipoleOp_pn(modelspace, 1, "spin");
  else if (opname == "M1L")
    theop = MagneticMultipoleOp_pn(modelspace, 1, "orbit");
  else if (opname == "Fermi")
    theop = AllowedFermi_Op(modelspace);
  else if (opname == "GamowTeller")
    theop = AllowedGamowTeller_Op(modelspace);
  else if (opname == "Iso2")
    theop = Isospin2_Op(modelspace);
  else if (opname == "R2CM")
    theop = R2CM_Op(modelspace);
  else if (opname == "Trel")
    theop = Trel_Op(modelspace);
  else if (opname == "TCM")
    theop = TCM_Op(modelspace);
  else if (opname == "Tlab")
    theop = KineticEnergy_Op(modelspace);
  else if (opname == "Rso")
    theop = RpSpinOrbitCorrection(modelspace);
  else if (opname == "RadialOverlap")
    theop = RadialOverlap(modelspace);  // Untested...
  else if (opname == "Sigma")
    theop = Sigma_Op(modelspace);
  else if (opname == "Sigma_p")
    theop = Sigma_Op_pn(modelspace, "proton");
  else if (opname == "Sigma_n")
    theop = Sigma_Op_pn(modelspace, "neutron");
  else if (opname == "L2rel")
    theop = L2rel_Op(modelspace);  // Untested...
  else if (opname == "QdotQ")
    theop = QdotQ_Op(modelspace);  // Untested...
  else if (opname == "VCoul")
    theop = VCoulomb_Op(modelspace);  // Untested...
  else if (opname == "hfsNMS")
    theop = atomic_hfs::NormalMassShift(modelspace, 1);
  else if (opname == "hfsSMS")
    theop = atomic_hfs::SpecificMassShift(modelspace, 1);
  else if (opname == "VCentralCoul")
    theop = VCentralCoulomb_Op(modelspace);
  else if (opname == "AxialCharge")
    theop = AxialCharge_Op(modelspace);  // Untested...
  else if (opname == "VMinnesota")
    theop = MinnesotaPotential(modelspace);
  else if (opname == "VBareDelta")
    theop = BareDelta(modelspace);
  else if (opname == "OccRef")
    theop = NumberOpRef(modelspace);
    ...
    //        std::cout << "    " << opnamesplit[0] << " " << opnamesplit[1] <<
    //        " " << opnamesplit[2] << std::endl;
    double V0 = 1.0;
    double R = 1.0;
    ...
    //         {
    double hw_HCM =
        modelspace.GetHbarOmega();  // frequency of trapping potential
    if (opnamesplit.size() > 1) {
      std::istringstream(opnamesplit[1]) >> hw_HCM;
    }
    int A = modelspace.GetTargetMass();
    //           std::cout << "Calling HCM with hw = " << hw_HCM << " target
    //           mass = " << A << std::endl;
    theop = TCM_Op(modelspace) + 0.5 * A * M_NUCLEON * hw_HCM * hw_HCM / HBARC /
                                     HBARC * R2CM_Op(modelspace);
    //         }
  } else if (opnamesplit[0] ==
             "VCM")  // GetHCM with a different frequency, ie HCM_24 for hw=24
  {
    double hw_VCM =
        modelspace.GetHbarOmega();  // frequency of trapping potential
    if (opnamesplit.size() > 1) {
    ...
    int A = modelspace.GetTargetMass();
    theop = 0.5 * A * M_NUCLEON * hw_VCM * hw_VCM / HBARC / HBARC *
            R2CM_Op(modelspace);
  } else if (opnamesplit[0] == "Rp2Z")  // Get point proton radius for specified
                                        // Z, e.g. Rp2Z_10 for neon
  {
    int Z_rp;
    std::istringstream(opnamesplit[1]) >> Z_rp;
    theop = Rp2_corrected_Op(modelspace, modelspace.GetTargetMass(), Z_rp);
  } else if (opnamesplit[0] ==
             "Rp2AZ")  // Get point proton radius for specified A and Z, e.g.
                       // Rp2AZ_20_10 for neon
  {
    int A_rp;
    int Z_rp;
    ...
    theop = Rp2_corrected_Op(modelspace, A_rp, Z_rp);
             ...
             "Rn2Z")  // Get point neutron radius for specified Z
  {
    int Z_rp;
    std::istringstream(opnamesplit[1]) >> Z_rp;
    theop = Rn2_corrected_Op(modelspace, modelspace.GetTargetMass(), Z_rp);
  } else if (opnamesplit[0] ==
             "rhop")  // point proton  density at position r, e.g. rhop_1.25
  {
    double rr;
  ...
  } else if (opnamesplit[0] == "rhon")  // point neutron density at position r
  {
    double rr;
    std::istringstream(opnamesplit[1]) >> rr;
    theop = DensityAtR(modelspace, rr,
                       "neutron");  // whoops... I'd forgotten the "theop = ".
                                    // Thanks Johannes...
  } else if (opnamesplit[0] ==
             "rhocentralp")  // central point proton density, averaged over a
                             // sphere of radius rmax
  {
    ...
    for (int ipoint = 1; ipoint < npoints; ipoint++)
      theop += (ipoint + 0.5) * (ipoint + 0.5) *
               DensityAtR(modelspace, dr * (ipoint + 0.5), "proton");
    for (int ipoint = 1; ipoint < npoints; ipoint++)
      norm += (ipoint + 0.5) * (ipoint + 0.5);
    theop /= norm;
  } else if (opnamesplit[0] ==
             "rhocentraln")  // central point neutron density, averaged over a
                             // sphere of radius rmax
  {
    double rmax;
    std::istringstream(opnamesplit[1]) >> rmax;
    ...
    for (int ipoint = 1; ipoint < npoints; ipoint++)
      theop += (ipoint + 0.5) * (ipoint + 0.5) *
               DensityAtR(modelspace, dr * (ipoint + 0.5), "neutron");
    for (int ipoint = 1; ipoint < npoints; ipoint++)
      norm += (ipoint + 0.5) * (ipoint + 0.5);
    theop /= norm;
  } else if (opnamesplit[0] == "FFp")  // point proton  form factor F(q), e.g.
                                       // FFp_1.25, where q is in fm^-1
  {
    double q;
    std::istringstream(opnamesplit[1]) >> q;
    theop = FormfactorAtQ(modelspace, q, "proton");
  } else if (opnamesplit[0] == "FFn")  // point neutron  form factor F(q), e.g.
                                       // FFp_1.25, where q is in fm^-1
  {
    double q;
    std::istringstream(opnamesplit[1]) >> q;
    theop = FormfactorAtQ(modelspace, q, "neutron");
             ...
             "OneOcc")  // Get occupation of specified orbit, e.g. OneOccp_1p3
  {
    ...
    theop = NumberOp(modelspace, oi.n, oi.l, oi.j2, oi.tz2);
             ...
             "AllOcc")  // Get occupation of orbit, summed over all values of
                        // radial quantum number n, e.g. AllOccpp3
  {
             ...
             "neutronFBC")  // Fourier bessel coefficient of order nu
  {
    ...
    if (opnamesplit.size() < 2)
      std::cout << "ERROR!!!  " << __func__
                << "    need to specify a cutoff for M0nuCT" << std::endl;
    std::istringstream(opnamesplit[1]) >> R0;
    theop = M0nu_contact_Op(modelspace, R0);
  }

  else if (opnamesplit[0] == "DMNREFT")  // Dark matter non-relativistic EFT
                                         // operators: M+, M-, ...
  {
    ...
    int J;
    std::string dmopname =
        opnamesplit[1].substr(0, opnamesplit[1].length() - 1);
    IsoSV = opnamesplit[1].back();
    std::istringstream(opnamesplit[2]) >> q;
    std::istringstream(opnamesplit[3]) >> J;

    std::map<std::string, Operator (*)(ModelSpace&, std::string, int, double)>
        dmop = {
            {"M", &DM_NREFT::M},           {"Sigma", &DM_NREFT::Sigma},
            {"Sigmap", &DM_NREFT::Sigmap}, {"Sigmapp", &DM_NREFT::Sigmapp},
            {"Delta", &DM_NREFT::Delta},   {"Deltap", &DM_NREFT::Deltap},
            {"Phipp", &DM_NREFT::Phipp},   {"Phitp", &DM_NREFT::Phitp},
    ...
    theop = DaggerAlln_Op(modelspace, Q);
             ...
             "M0nu")  // Neutrinoless Double Beta Decay Operators   format e.g.
                      // M0nu_GT_7.72_none or M0nu_F_12.6_AV18
  {
    double Eclosure;
    std::string M0nuopname = opnamesplit[1];
    std::istringstream(opnamesplit[2]) >> Eclosure;
    std::string src = opnamesplit[3];
    std::map<std::string, Operator (*)(ModelSpace&, double, std::string)>
        M0nuop = {
            {"GT", &M0nu::GamowTeller},
            {"F", &M0nu::Fermi},
            {"T", &M0nu::Tensor},
...
Operator NumberOp(ModelSpace& modelspace, int n, int l, int j2, int tz2) {
  ...
  std::cout << "Number op indx = " << indx << " one body = " << NumOp.OneBody
            << std::endl;
  return NumOp;
}
...
Operator OneBodyDensity(ModelSpace& modelspace, index_t i, index_t j) {
  ...
  OBD.OneBody(i, j) += 0.5;
  OBD.OneBody(j, i) += 0.5;
  std::cout << "OBD ij = " << i << " " << j << "  One body = " << OBD.OneBody
            << std::endl;
  return OBD;
}

/// Gives \f$ rho_{n,l}(r)\f$ , the norm squared of the harmonic oscillator
/// radial wave function evaluated at r. This is normalized so that integrating
/// \f$ rho(r) r^2 dr \f$ gives 1. This means that it is related to the acutal
/// density by a factor of $\f 4\pi \f$. This is equivalent to squaring the
/// return value of HO_Radial_psi().
double HO_density(int n, int l, double hw, double r) {
  double v = M_NUCLEON * hw / (HBARC * HBARC);
  double Norm = pow(v / 2., 1.5 + l) * SQRT2 / SQRTPI * pow(2, n + 2 * l + 3) *
                gsl_sf_fact(n) / gsl_sf_doublefact(2 * n + 2 * l + 1);
...
double HO_Radial_psi(int n, int l, double hw, double r) {
  ...
  double x = r / b;
  double Norm = 2 * sqrt(gsl_sf_fact(n) * pow(2, n + l) / SQRTPI /
                         gsl_sf_doublefact(2 * n + 2 * l + 1) / pow(b, 3.0));
...
std::vector<double> GetOccupationsHF(HartreeFock& hf) {
  ...
  for (int i = 0; i < norb; ++i) {
    ...
    std::cout << oi.n << " " << oi.l << " " << oi.j2 << "/2 " << occupation[i]
              << std::endl;
  }
  return occupation;
}
...
std::vector<double> GetDensity(std::vector<double>& occupation,
                               std::vector<double>& R, std::vector<int>& orbits,
...
void WriteSPWaveFunctions(std::vector<std::string>& spwf, HartreeFock& hf,
                          std::string intfile) {
  ...
  for (int rstep = 0; rstep < n_radial_points; ++rstep)
    R[rstep] = Rmax / n_radial_points * rstep;
  for (index_t i = 0; i < spwf.size(); ++i) {
    hf.GetRadialWF(spwf_indices[i], R, PSI);
    std::ofstream wf_file(intfile + "_spwf_" + spwf[i] + ".dat");
    for (index_t rstep = 0; rstep < R.size(); ++rstep)
      wf_file << std::fixed << std::setw(10) << std::setprecision(7) << R[rstep]
              << "   " << std::setw(10) << std::setprecision(7) << PSI[rstep]
              << std::endl;
    wf_file.close();
  }
}
...
// and the fact that the nonrelativistic kinetic energy acts as a 'hopping
// operator' so acting p^2/2m on a state |nl> returns a linear combination of
// |nl> |(n+1)l> and |(n-1)l>. Specifically, we write this as (p^2/2m) |nl> = N0
// |nl> + Np |(n+1)l> + Nm |(n-1)l> where N0 = (2n+l+3/2)hw/2,   Np =
// sqrt((n+1)(n+l+3/2))hw/2,   Nm = sqrt(n(n+l+1/2))hw/2. Then we act again with
// p^2/2m to get the action of p^4/4m. p^4/(4m^2) |n> = Npp|n+2> +
// (Np0+N0p)|n+1> + (N00 + Npm + Nmp)|n> + (Nm0+N0m)|n-1> + Nmm |n-2> where Np0
// = sqrt[ (n+1)(n+l+3/2) ] (2n+l+3/2)             (hw/2)^2 N0p = (2n+l+7/2)
// sqrt[ (n+1)(n+l+3/2) ]             (hw/2)^2 N00 = (2n+2+3/2) (2n+l+3/2)
// (hw/2)^2 Nm0 = sqrt[ n(n+l+1/2) ]  (2n+l+3/2)                (hw/2)^2 N0m =
// (2n+l-1/2) sqrt[ n(n+l+1/2) ]                 (hw/2)^2 Npp = sqrt[
// (n+2)(n+l+5/2)] sqrt[ (n+1)(n+l+3/2) ]  (hw/2)^2 Npm = sqrt[ n(n+l+1/2)]
// sqrt[ n(n+l+1/2) ]     (hw/2)^2 Nmp = sqrt[ (n+1)(n+l+3/2)]  sqrt[
// (n+1)(n+l+3/2) ] (hw/2)^2 Nmm = sqrt[ (n-1)(n+l-1/2) ] sqrt[ n(n+l+1/2) ]
// (hw/2)^2
/// Leading relativistic correction to the kinetic energy
Operator KineticEnergy_RelativisticCorr(ModelSpace& modelspace) {
  ...
  for (int a = 0; a < norbits; ++a) {
    ...
    double Npp =
        sqrt((na + 2) * (na + la + 2.5)) * sqrt((na + 1) * (na + la + 1.5));
    double Np0 = sqrt((na + 1) * (na + la + 1.5)) * (2 * na + la + 1.2);
    double N0p = (2 * na + la + 3.5) * sqrt((na + 1) * (na + la + 1.5));
    double N00 = (2 * na + la + 1.5) * (2 * na * la + 1.5);
    double Nmp =
        sqrt((na + 1) * (na + la + 1.5)) * sqrt((na + 1) * (na + la + 1.5));
    double Npm =
        na < 1 ? 0 : sqrt(na * (na + la + 0.5)) * sqrt(na * (na + la + 0.5));
...
/// \frac{\hbar\omega}{A}\frac{1}{4}\sum_{ijkl} t_{ijkl}
/// a^{\dagger}_{i}a^{\dagger}_{j}a_{l}a_{k} \f] with a one-body piece \f[
/// t_{ij} = \frac{1}{\hbar\omega} \left\langle i | T_{12} | j \right\rangle =
/// \frac{1}{2}(2n_i+\ell_i+3/2) \delta_{ij} +
/// \frac{1}{2}\sqrt{n_j(n_j+\ell_j+\frac{1}{2})} \delta_{n_i,n_j-1}\delta_{k_i
/// k_j} \f] where \f$ k \f$ labels all quantum numbers other than \f$ n \f$ and
/// a two-body piece \f[ t_{ijkl} = \frac{1}{\hbar\omega} \left\langle ij |
/// (T^{CM}_{12} - T^{rel}_{12}) | kl \right\rangle \f]
Operator TCM_Op(ModelSpace& modelspace) {
  ...
  int A = modelspace.GetTargetMass();
  if (A < 1)
    std::cout << "DANGER!!! Calling " << __func__ << "  with A=" << A
              << std::endl;
  ...
  for (int i = 0; i < norb; ++i) {
    ...
    for (int j : TcmOp.OneBodyChannels.at({oi.l, oi.j2, oi.tz2})) {
      ...
      double tij = 0;
      if (oi.n == oj.n)
        tij = 0.5 * (2 * oi.n + oi.l + 1.5) * hw / A;
      else if (oi.n == oj.n - 1)
        tij = 0.5 * sqrt(oj.n * (oj.n + oj.l + 0.5)) * hw / A;
...
#pragma omp parallel for schedule(dynamic, \
                                  1)  // In order to make this parallel, need to
                                      // precompute the Moshinsky brackets.
  for (int ch = 0; ch < nchan; ++ch) {
    ...
    for (int ibra = 0; ibra < nkets; ++ibra) {
      ...
      for (int iket = ibra; iket < nkets; ++iket) {
        ...
        //            double p1p2 = Calculate_p1p2(modelspace,bra,ket,tbc.J) *
        //            hw/A;
...
/// This returns the antisymmetrized J-coupled two body matrix element of \f$
/// \vec{p}_1 \cdot \vec{p}_2 / (m) \f$. The formula is \f{eqnarray*}{
/// \frac{1}{m}
/// \left \langle a b \right| \vec{p}_1 \cdot \vec{p}_2 \left| c d \right
/// \rangle_J = \frac{1}{\sqrt{(1+\delta_{ab})(1+\delta_{cd})}}
/// &\sum\limits_{LS} \left[ \begin{array}{ccc}
///  \ell_a & s_a & j_a \\
///  \ell_b & s_b & j_b \\
///  L      & S   & J
/// \end{array} \right]
...
///  L      & S   & J
/// \end{array} \right] & \\
/// & \times \sum\limits_{\substack{N_{ab}N_{cd} \Lambda \\ n_{ab} n_{cd}
/// \lambda}} \mathcal{A}_{abcd}^{\lambda S} \times \left\langle N_{ab}\Lambda
/// n_{ab} \lambda | n_{a} \ell_{a} n_{b} \ell_{b} \right\rangle_{L} &
/// \left\langle N_{cd}\Lambda n_{cd} \lambda | n_{c} \ell_{c} n_{d} \ell_{d}
/// \right\rangle_{L} \\ & \times \left( \left\langle N_{ab}\Lambda | t_{cm} |
/// N_{cd} \Lambda \right \rangle
/// -\left\langle n_{ab}\lambda | t_{rel} | n_{cd} \lambda \right \rangle
/// \right) \f} The antisymmetrization factor \f$ \mathcal{A}_{abcd}^{\lambda S}
/// \f$ ensures that the relative wave function is antisymmetrized. It is given
/// by \f$ \mathcal{A}_{abcd}^{\lambda S} = \left|t_{za}+t_{zc}\right| + \left|
/// t_{za} + t_{zd} \right| (-1)^{\lambda + S + \left|T_z\right|}\f$ .
///
/// The center-of-mass and relative kinetic energies can be found by the same
/// equation as used in the one-body piece of TCM_Op()
double Calculate_p1p2(ModelSpace& modelspace, Ket& bra, Ket& ket, int J) {
  ...
  for (int Lab = std::abs(la - lb); Lab <= la + lb; ++Lab) {
    for (int Sab = 0; Sab <= 1; ++Sab) {
      ...
      {
        for (int Lam_ab = 0; Lam_ab <= fab - 2 * N_ab;
             ++Lam_ab)  // Lam_ab = CoM l for a,b
        {
          int Lam_cd = Lam_ab;  // tcm and trel conserve lam and Lam, ie
                                // relative and com orbital angular momentum
          for (int lam_ab = (fab - 2 * N_ab - Lam_ab) % 2;
               lam_ab <= (fab - 2 * N_ab - Lam_ab);
               lam_ab += 2)  // lam_ab = relative l for a,b
          {
            if (Lab < std::abs(Lam_ab - lam_ab) or Lab > (Lam_ab + lam_ab))
              continue;
            // factor to account for antisymmetrization

            int asymm_factor = (std::abs(bra.op->tz2 + ket.op->tz2) +
                                std::abs(bra.op->tz2 + ket.oq->tz2) *
                                    modelspace.phase(lam_ab + Sab)) /
                               2;
            if (asymm_factor == 0) continue;

            int lam_cd = lam_ab;  // tcm and trel conserve lam and Lam
            int n_ab = (fab - 2 * N_ab - Lam_ab - lam_ab) /
                       2;  // n_ab is determined by energy conservation

            double mosh_ab = modelspace.GetMoshinsky(N_ab, Lam_ab, n_ab, lam_ab,
                                                     na, la, nb, lb, Lab);

            if (std::abs(mosh_ab) < 1e-8) continue;

            for (int N_cd = std::max(0, N_ab - 1); N_cd <= N_ab + 1;
                 ++N_cd)  // N_cd = CoM n for c,d
            {
              int n_cd = (fcd - 2 * N_cd - Lam_cd - lam_cd) /
                         2;  // n_cd is determined by energy conservation
              if (n_cd < 0) continue;
              if (n_ab != n_cd and N_ab != N_cd) continue;

              double mosh_cd = modelspace.GetMoshinsky(
                  N_cd, Lam_cd, n_cd, lam_cd, nc, lc, nd, ld, Lcd);
              ...
              if (n_ab == n_cd) {
                if (N_ab == N_cd)
                  tcm = (2 * N_ab + Lam_ab + 1.5);
                else if (N_ab == N_cd + 1)
                  tcm = sqrt(N_ab * (N_ab + Lam_ab + 0.5));
                else if (N_ab == N_cd - 1)
                  tcm = sqrt(N_cd * (N_cd + Lam_ab + 0.5));
              }
              if (N_ab == N_cd) {
                if (n_ab == n_cd)
                  trel = (2 * n_ab + lam_ab + 1.5);
                else if (n_ab == n_cd + 1)
                  trel = sqrt(n_ab * (n_ab + lam_ab + 0.5));
                else if (n_ab == n_cd - 1)
                  trel = sqrt(n_cd * (n_cd + lam_cd + 0.5));
              }
  ...
  p1p2 *= 0.5 * modelspace.GetHbarOmega() /
          sqrt((1.0 + bra.delta_pq()) * (1.0 + ket.delta_pq()));
  return p1p2;
}
...
Operator Trel_Masscorrection_Op(ModelSpace& modelspace) {
  ...
  for (int a = 0; a < norbits; ++a) {
    ...
    for (int b : dTrel.OneBodyChannels.at({oa.l, oa.j2, oa.tz2})) {
      ...
      if (oa.n == ob.n + 1)
        dTrel.OneBody(a, b) =
            correction * 0.5 * hw * sqrt((oa.n) * (oa.n + oa.l + 1. / 2));
      else if (oa.n == ob.n - 1)
        dTrel.OneBody(a, b) =
            correction * 0.5 * hw * sqrt((ob.n) * (ob.n + ob.l + 1. / 2));
...
void Calculate_p1p2_all(Operator& OpIn) {
  ...
  for (int ch : modelspace->SortedTwoBodyChannels) {
    ...
    int emax_ket =
        2 * ketlast.op->n + 2 * ketlast.oq->n + ketlast.op->l + ketlast.oq->l;
      ...
      for (int S = std::abs(J - L); S <= 1; ++S) {
        for (int N = 0; N <= emax_ket / 2; ++N) {
          for (int Lambda = 0; Lambda <= (emax_ket - 2 * N); ++Lambda) {
            for (int lambda = std::abs(L - Lambda) + (L + parity) % 2;
                 lambda <= std::min(Lambda + L, emax_ket - 2 * N - Lambda);
                 lambda += 2) {
              for (int n = 0; n <= (emax_ket - 2 * N - Lambda - lambda) / 2;
                   ++n) {
    ...
    for (int iJJ = 0; iJJ < nkets_JJ; ++iJJ) {
      ...
      for (int iJac = 0; iJac < nkets_Jacobi; ++iJac) {
        ...
        double mosh =
            modelspace->GetMoshinsky(N, Lambda, n, lambda, na, la, nb, lb, L);
    ...
    for (int i = 0; i < nkets_Jacobi; ++i) {
      ...
      for (int j = 0; j < nkets_Jacobi; ++j) {
        ...
        if (Li != Lj or Si != Sj or Lambdai != Lambdaj or lambdai != lambdaj)
          continue;
        double tcm = 0;
        double trel = 0;
        if (ni == nj) {
          if (Ni == Nj)
            tcm = (2 * Ni + Lambdai + 1.5);
          else if (Ni == Nj + 1)
            tcm = sqrt(Ni * (Ni + Lambdai + 0.5));
          else if (Ni == Nj - 1)
            tcm = sqrt(Nj * (Nj + Lambdai + 0.5));
        }
        if (Ni == Nj) {
          if (ni == nj)
            tcm = (2 * ni + lambdai + 1.5);
    ...
    std::cout << "ch = " << ch << "   size of JJ basis = " << nkets_JJ
              << "  size of Jacobi Basis = " << nkets_Jacobi
              << "   nonzero matrix elements = " << n_nonzero << std::endl;
  }
}
...
/// \frac{1}{A^2} \left( \sum_{i}r_{i}^{2} + 2\sum_{i<j}\vec{r}_i\cdot\vec{r}_j
/// \right) \f] evaluated in the oscillator basis.
...
#pragma omp parallel for schedule(dynamic, 1)
  for (int ch = 0; ch < nchan; ++ch) {
    ...
    for (int ibra = 0; ibra < nkets; ++ibra) {
      ...
      for (int iket = ibra; iket < nkets; ++iket) {
        Ket& ket = tbc.GetKet(iket);
        // factor of 2 comes from limiting sum to i<j. Otherwise it would be
        // r1*r2 + r2*r1.
...
/// R^2_{CM} + \frac{A-2}{AZ} \sum_{p}r_{p}^{2} -
/// \frac{4}{AZ}\sum_{i<j}\vec{r}_i\cdot\vec{r}_j \f] evaluated in the
/// oscillator basis.
Operator Rp2_corrected_Op(ModelSpace& modelspace, int A, int Z) {
  if (Z == 0) return 0.0 * KineticEnergy_Op(modelspace);
  return R2CM_Op(modelspace) +
         (A - 2.0) / (A * Z) * R2_1body_Op(modelspace, "proton") -
...
Operator Rn2_corrected_Op(ModelSpace& modelspace, int A, int Z) {
  ...
  return R2CM_Op(modelspace) +
         (A - 2.0) / (A * (A - Z)) * R2_1body_Op(modelspace, "neutron") -
...
// Evaluate <bra | r1*r2 | ket>, omitting the factor (hbar * omega) /(m *
// omega^2)
/// Returns the normalized, anti-symmetrized, J-coupled, two-body matrix element
/// of \f$  \vec{r}_1\cdot\vec{r}_2 \f$. Calculational details are similar to
/// imsrg_util::Calculate_p1p2().
double Calculate_r1r2(ModelSpace& modelspace, Ket& bra, Ket& ket, int J) {
  ...
  int fab = 2 * na + 2 * nb + la + lb;
  int fcd = 2 * nc + 2 * nd + lc + ld;
  if (std::abs(fab - fcd) % 2 > 0)
    return 0;  // p1*p2 only connects kets with delta N = 0,1
  if (std::abs(fab - fcd) > 2)
    return 0;  // p1*p2 only connects kets with delta N = 0,1
      ...
      for (int N_ab = 0; N_ab <= fab / 2; ++N_ab)  // N_ab = CoM n for a,b
      {
             ...
             ++Lam_ab)  // Lam_ab = CoM l for a,b
        {
               ...
               lam_ab += 2)  // lam_ab = relative l for a,b
          {
            ...
            //              std::cout << __func__ << "na la nb lb " << na << " "
            //              << la << " " << nb << " " << lb << std::endl;
            double mosh_ab = modelspace.GetMoshinsky(N_ab, Lam_ab, n_ab, lam_ab,
                                                     na, la, nb, lb, Lab);
                 ...
                 ++N_cd)  // N_cd = CoM n for c,d
            {
              ...
              //              std::cout << __func__ << "nc lc nd ld " << nc << "
              //              " << lc << " " << nd << " " << ld << std::endl;
              double mosh_cd = modelspace.GetMoshinsky(
                  N_cd, Lam_cd, n_cd, lam_cd, nc, lc, nd, ld, Lcd);
              if (std::abs(mosh_cd) < 1e-8) continue;
              ...
              if (N_ab == N_cd) {
                if (n_ab == n_cd)
                  ...
                  r2rel = -sqrt(n_cd * (n_cd + lam_cd + 0.5));
              }
              double prefactor = njab * njcd * mosh_ab * mosh_cd * asymm_factor;
...
Operator HCM_Op(ModelSpace& modelspace) {
  double hw = modelspace.GetHbarOmega();
  int A = modelspace.GetTargetMass();
  Operator HcmOp = TCM_Op(modelspace) + 0.5 * A * M_NUCLEON * hw * hw / HBARC /
                                            HBARC * R2CM_Op(modelspace);
...
Operator R2_1body_Op(ModelSpace& modelspace, std::string option) {
  ...
  if (option == "neutron" or option == "matter")
    orbitlist.insert(modelspace.neutron_orbits.begin(),
                     modelspace.neutron_orbits.end());
  if (option == "proton" or option == "matter")
    orbitlist.insert(modelspace.proton_orbits.begin(),
                     modelspace.proton_orbits.end());
  else if (option != "proton" and option != "neutron" and option != "matter")
    std::cout << "!!! WARNING. " << __func__ << "  BAD OPTION " << option
              << std::endl;
...
#pragma omp parallel for schedule(dynamic, 1)
  for (int ch = 0; ch < nchan; ++ch) {
    TwoBodyChannel& tbc = modelspace.GetTwoBodyChannel(ch);
    int Tz = tbc.Tz;
    if (option == "proton" and Tz > 0)
      continue;  // don't bother with nn channel
    if (option == "neutron" and Tz < 0)
      continue;  // don't bother with pp channel
    int nkets = tbc.GetNumberKets();
    for (int ibra = 0; ibra < nkets; ++ibra) {
      Ket& bra = tbc.GetKet(ibra);
      double prefactor =
          1;  // factor to account for double counting in pn channel.
      //          if ( (bra.op->l > modelspace.GetLmax()) or (bra.oq->l >
      //          modelspace.GetLmax()) )
      //          {
      //            std::cout << "ibra is " << ibra << " => " << bra.p << " " <<
      //            bra.q << "  => " << bra.op->l << " " <<  bra.oq->l <<
      //            std::endl;
      //          }
      if (Tz == 0 and (option == "proton" or option == "neutron"))
        prefactor = 0.5;
      for (int iket = ibra; iket < nkets; ++iket) {
        Ket& ket = tbc.GetKet(iket);
...
Operator DensityAtR(ModelSpace& modelspace, double R, std::string pn) {
  ...
  auto pn_list =
      pn == "proton" ? modelspace.proton_orbits : modelspace.neutron_orbits;
  for (auto i : pn_list) {
    Orbit& oi = modelspace.GetOrbit(i);
    for (auto j : Rho.OneBodyChannels.at({oi.l, oi.j2, oi.tz2})) {
      Orbit& oj = modelspace.GetOrbit(j);
      Rho.OneBody(i, j) = HO_Radial_psi(oi.n, oi.l, hw, R) *
                          HO_Radial_psi(oj.n, oj.l, hw, R) / fourpi;
    }
  }
  return Rho;
}
...
/// We absorb the \f$ 4pi \f$ by using radial wave functions which are
/// normalized to 1. The form factor is normalized such that for protons \f$
/// F(q=0) = Z \f$ and likewise for neutrons. At low q, the form factor behaves
/// as \f$ F(q\approx = 0) = Z(1 - r^2 q^2 / 6) \f$, where $r^2$ is the rms
/// point proton radius. NB, PREX-II measurement is at Q^2=0.0062 GeV^2 => Q
/// = 78.74 MeV =~ 0.4 fm^-1.  PREX-I is at 0.475 fm^-1
Operator FormfactorAtQ(ModelSpace& modelspace, double q, std::string pn) {
  ...
  for (int ix = 0; ix < npoints; ix++) {
    ...
    weights[ix] = GaussLaguerre::gauss_laguerre_points_200[ix][1] * xvals[ix] *
                  xvals[ix];  // includes x^2 from jacobian
  ...
  for (auto i : pn_list) {
    ...
    // compare with HO_Radial_psi: no factor sqrt(1/b^3) because we have a b^3
    // out front from changing variables from r to r/b.
    double Norm_i = 2 * sqrt(gsl_sf_fact(oi.n) * pow(2, oi.n + oi.l) / SQRTPI /
                             gsl_sf_doublefact(2 * oi.n + 2 * oi.l + 1));

    for (int ix = 0; ix < npoints; ix++) {
      double x = xvals[ix];
      // extra +x in exponent comes from Gauss-Laguerre weighting.
      phi_i[ix] = Norm_i * pow(x, oi.l) * exp(-x * x * 0.5 + x) *
                  gsl_sf_laguerre_n(oi.n, oi.l + 0.5, x * x);
    }
    for (auto j : Fq.OneBodyChannels.at({oi.l, oi.j2, oi.tz2})) {
      ...
      double Norm_j =
          2 * sqrt(gsl_sf_fact(oj.n) * pow(2, oj.n + oj.l) / SQRTPI /
                   gsl_sf_doublefact(2 * oj.n + 2 * oj.l + 1));
      std::vector<double> phi_j(npoints, 0.);
      for (int ix = 0; ix < npoints; ix++) {
        double x = xvals[ix];
        // Notice no +x in the exponent here
        phi_j[ix] = Norm_j * pow(x, oj.l) * exp(-x * x * 0.5) *
                    gsl_sf_laguerre_n(oj.n, oj.l + 0.5, x * x);
      }
      double fq_ij = 0;
      for (int ix = 0; ix < npoints; ix++) {
...
//  providing an index list allows us to select e.g. just protons or just
//  neutrons
// Operator FourierBesselCoeff(ModelSpace& modelspace, int nu, double R,
// std::vector<index_t> index_list)
Operator FourierBesselCoeff(ModelSpace& modelspace, int nu, double R,
                            std::set<index_t> index_list) {
  Operator a_nu(modelspace, 0, 0, 0, 2);

  size_t npoints =
      99;  // should be a multiple of 3 so we can use the Simpson 3/8 rule
  ...
  for (auto p : index_list) {
    ...
    for (auto q : a_nu.OneBodyChannels.at({op.l, op.j2, op.tz2})) {
      ...
      for (size_t i = 0; i < npoints; i++) {
        INTEGRAND[i] = HO_Radial_psi(oq.n, oq.l, hw, RGRID[i]) * RGRID[i] *
                       RGRID[i] * BESSEL[i] * PSI_p[i];
      }

      double integral = INTEGRAND[0] + INTEGRAND[npoints - 1];
      for (size_t i = 1; i < npoints; i += 3) {
        integral +=
            3 * INTEGRAND[i] + 3 * INTEGRAND[i + 1] + 2 * INTEGRAND[i + 2];
      }
      integral *= 3. / 8 * dr;
      integral *= Q * Q;
  ...
  return a_nu;  // There may need to be some additional normalization by pi or
                // something...
}
    ...
    if (std::abs(tbc.Tz) == 1) {
      ...
      for (size_t ibra = 0; ibra < tbc.GetNumberKets(); ++ibra) {
        ...
        for (size_t iket = ibra; iket < tbc.GetNumberKets(); ++iket) {
          ...
          Orbit& oc = modelspace.GetOrbit(ket.p);
          Orbit& od = modelspace.GetOrbit(ket.q);
          if (oa.j2 == oc.j2 and oa.n == oc.n and oa.l == oc.l and
              ob.j2 == od.j2 and ob.n == od.n and ob.l == od.l) {
            // tz1 tz2 case
...
/// Mutipole responses (except dipole) with units fm\f$ ^{rL}\f$ (see
/// PRC97(2018)054306 ) --added by bhu
Operator MultipoleResponseOp(ModelSpace& modelspace, int rL, int YL) {
  Operator EL(modelspace, YL, 0, YL % 2, 2);
  double bL = pow(HBARC * HBARC / M_NUCLEON / modelspace.GetHbarOmega(),
                  0.5 * rL);  // b^L where b=sqrt(hbar/mw)
  int norbits = modelspace.GetNumberOrbits();
  for (int i = 0; i < norbits; ++i) {
    ...
    for (int j : EL.OneBodyChannels.at({oi.l, oi.j2, oi.tz2})) {
      ...
      EL.OneBody(i, j) =
          modelspace.phase(jj + YL - 0.5) *
          sqrt((2 * ji + 1) * (2 * jj + 1) * (2 * YL + 1) / 4. / 3.1415926) *
          AngMom::ThreeJ(ji, jj, YL, 0.5, -0.5, 0) * r2int;
      if (YL == 0) EL.OneBody(i, j) = EL.OneBody(i, j) * sqrt(4. * 3.1415926);
      EL.OneBody(j, i) =
          modelspace.phase((oi.j2 - oj.j2) / 2) * EL.OneBody(i, j);
    }
  }
  return EL;
}
  ...
  for (int i = 0; i < norbits; ++i) {
    ...
    for (int j : EL.OneBodyChannels.at({oi.l, oi.j2, oi.tz2})) {
      ...
      EL.OneBody(i, j) =
          ...
          sqrt((2 * ji + 1) * (2 * jj + 1) * (2 * YL + 1) / 4. / 3.1415926) *
          AngMom::ThreeJ(ji, jj, YL, 0.5, -0.5, 0) * r2int;
      EL.OneBody(i, j) = EL.OneBody(i, j) * (0.5 - oi.tz2 * 0.5 -
                                             modelspace.GetTargetZ() * 1.0 /
...
/// Returns a reduced electric multipole operator with units \f$ e\f$
/// fm\f$^{\lambda} \f$ See Suhonen eq. (6.23)
Operator ElectricMultipoleOp(ModelSpace& modelspace, int L) {
  Operator EL(modelspace, L, 0, L % 2, 2);
  double bL = pow(HBARC * HBARC / M_NUCLEON / modelspace.GetHbarOmega(),
                  0.5 * L);  // b^L where b=sqrt(hbar/mw)
  for (int i : modelspace.proton_orbits) {
    ...
    for (int j : EL.OneBodyChannels.at({oi.l, oi.j2, oi.tz2})) {
      ...
      EL.OneBody(i, j) =
          modelspace.phase(jj + L - 0.5) *
          sqrt((2 * ji + 1) * (2 * jj + 1) * (2 * L + 1) / 4. / 3.1415926) *
          AngMom::ThreeJ(ji, jj, L, 0.5, -0.5, 0) * r2int;
      EL.OneBody(j, i) =
          modelspace.phase((oi.j2 - oj.j2) / 2) * EL.OneBody(i, j);
    }
  }
...
/// Returns a reduced magnetic multipole operator with units \f$ \mu_{N}\f$
/// fm\f$ ^{\lambda-1} \f$
...
/// Returns a reduced magnetic multipole operator with units \f$ \mu_{N}\f$
/// fm\f$ ^{\lambda-1} \f$ This version allows for the selection of just proton
/// or just neutron contributions, or both. See Suhonen eq. (6.24)
Operator MagneticMultipoleOp_pn(ModelSpace& modelspace, int L, std::string pn) {
  double bL =
      pow(HBARC * HBARC / M_NUCLEON / modelspace.GetHbarOmega(), 0.5 * (L - 1));
  Operator ML(modelspace, L, 0, (L + 1) % 2, 2);
  if (L < 1) {
    std::cout << "A magnetic monopole operator??? Setting it to zero..."
              << std::endl;
    return ML;
  }
  bool spin = true;
  ...
  for (int i = 0; i < norbits; ++i) {
    ...
    double gs = oi.tz2 < 0
                    ? PROTON_SPIN_G
                    : NEUTRON_SPIN_G;  // These are 5.586 and -3.826 for proton
                                       // and neutron, respectively. Defined in
    ...
    for (int j : ML.OneBodyChannels.at({oi.l, oi.j2, oi.tz2})) {
      ...
      double kappa = modelspace.phase(oi.l + ji + 0.5) * (ji + 0.5) +
                     modelspace.phase(oj.l + jj + 0.5) * (jj + 0.5);
      ML.OneBody(i, j) =
          modelspace.phase(jj + L - 0.5) *
          sqrt((2 * ji + 1) * (2 * jj + 1) * (2 * L + 1) / 4. / 3.1415926) *
          AngMom::ThreeJ(ji, jj, L, 0.5, -0.5, 0) * (L - kappa) *
          (gl * (1 + kappa / (L + 1.)) - 0.5 * gs) * r2int;
      ML.OneBody(j, i) =
          modelspace.phase((oi.j2 - oj.j2) / 2) * ML.OneBody(i, j);
    }
  }
  return ML;
}
...
Operator IntrinsicElectricMultipoleOp(ModelSpace& modelspace, int L) {
  Operator EL(modelspace, L, 0, L % 2, 2);
  double bL = pow(HBARC * HBARC / (0.5 * M_NUCLEON) / modelspace.GetHbarOmega(),
                  0.5 * L);  // b^L where b=sqrt(hbar/mw)
    ...
    for (int lrela = 0; lrela < 2 * emax - 2 * nrela; lrela += 1) {
      ...
      for (int lrelb = std::abs(lrela - L); lrelb <= lrela + L; lrelb += 2) {
        for (int nrelb = 0; 2 * nrelb <= 2 * emax - lrelb; nrelb += 1) {
          ...
          double angint = modelspace.phase(lrela) *
                          sqrt((2 * lrela + 1) * (2 * lrelb + 1) * (2 * L + 1) /
                               4. / 3.1415926) *
                          AngMom::ThreeJ(lrela, L, lrelb, 0, 0, 0);
  ...
  for (auto& itmat : EL.TwoBody.MatEl) {
    ...
    for (size_t ibra = 0; ibra < tbc_bra.GetNumberKets(); ++ibra) {
      ...
      for (size_t iket = 0; iket < tbc_ket.GetNumberKets(); ++iket) {
        ...
        for (int Lab = std::max(std::abs(la - lb), std::abs(Jab - 1));
             Lab <= std::min(la + lb, Jab + 1); Lab += 1) {
          for (int Lcd = std::max(std::abs(lc - ld), std::abs(Jcd - 1)) +
                         (Lab + L) % 2;
               Lcd <= std::min(lc + ld, Jcd + 1); Lcd += 2) {
            for (int S = std::max(std::abs(Jab - Lab), std::abs(Jcd - Lcd));
                 S <= std::min(1, std::min(Jab + Lab, Jcd + Lcd)); S += 1) {
              double njab =
                  AngMom::NormNineJ(la, 0.5, ja, lb, 0.5, jb, Lab, S, Jab);
              double njcd =
                  AngMom::NormNineJ(lc, 0.5, jc, ld, 0.5, jd, Lcd, S, Jcd);
              ...
              for (int nab = 0; nab <= rho_ab; nab += 1) {
                for (int lab = 0; lab <= rho_ab - 2 * nab; lab += 1) {
                  ...
                  for (int Lam = std::abs(lab - Lab);
                       Lam <= std::min(lab + Lab, rho_ab - 2 * nab - lab);
                       Lam += 2) {
                    int N = rho_ab - 2 * nab - lab - Lam;
                    double moshab = modelspace.GetMoshinsky(
                        N, Lam, nab, lab, na, la, nb, lb, Lab);
                    if (std::abs(moshab) < 1e-8) continue;
                    for (int ncd = 0; ncd <= rho_cd; ncd += 1) {
                      for (int lcd = std::abs(Lam - Lcd) + (Lcd + Lam) % 2;
                           lcd <= std::min(rho_cd - 2 * ncd, Lab + Lcd);
                           lcd += 2) {
                        int icd =
                            (2 * ncd + lcd) * (2 * ncd + lcd + 1) / 2 + lcd;
                        double moshcd = modelspace.GetMoshinsky(
                            N, Lam, ncd, lcd, nc, lc, nd, ld, Lcd);
                        labME +=
                            njab * njcd * moshab * moshcd * ME_rel(iab, icd);
                      }
                    }
                  }
                }
...
/// \tilde{\mathcal{R}}^{\lambda}_{ab} = \int_{0}^{\infty} dx
/// \tilde{g}_{n_a\ell_a}(x)x^{\lambda+2}\tilde{g}_{n_b\ell_b}(x) \f] where \f$
/// \tilde{g}(x) \f$ is the radial part of the harmonic oscillator wave function
/// with unit oscillator length \f$ b=1 \f$ and \f$ x = r/b \f$. To obtain the
/// radial integral for some other oscillator length, multiply by \f$
/// b^{\lambda} \f$. This implementation uses eq (6.41) from Suhonen. Note this
/// is only valid for \f$ \ell_a+\ell_b+\lambda\f$ = even. If \f$
/// \ell_a+\ell_b+\lambda\f$ is odd, RadialIntegral_RpowK() is called.
double RadialIntegral(int na, int la, int nb, int lb, int L) {
  ...
  double term1 = AngMom::phase(na + nb) * gsl_sf_fact(tau_a) *
                 gsl_sf_fact(tau_b) *
                 sqrt(gsl_sf_fact(na) * gsl_sf_fact(nb) /
                      (tgamma(na + la + 1.5) * tgamma(nb + lb + 1.5)));
  //    double term1 = AngMom::phase(na+nb) *
  //    gsl_sf_fact(tau_a)*gsl_sf_fact(tau_b) *
  //    sqrt(gsl_sf_fact(na)*gsl_sf_fact(nb)
  //                   / (gsl_sf_gamma(na+la+1.5)*gsl_sf_gamma(nb+lb+1.5) ) );
  double term2 = 0;
  for (int sigma = sigma_min; sigma <= sigma_max; ++sigma) {
    //      term2 += gsl_sf_gamma(0.5*(la+lb+L)+sigma+1.5) /
    //      (gsl_sf_fact(sigma)*gsl_sf_fact(na-sigma)*gsl_sf_fact(nb-sigma)*gsl_sf_fact(sigma+tau_a-na)*gsl_sf_fact(sigma+tau_b-nb)
    //      );
    term2 += tgamma(0.5 * (la + lb + L) + sigma + 1.5) /
             (gsl_sf_fact(sigma) * gsl_sf_fact(na - sigma) *
              gsl_sf_fact(nb - sigma) * gsl_sf_fact(sigma + tau_a - na) *
              gsl_sf_fact(sigma + tau_b - nb));
  }
  return term1 * term2;
}
...
double RadialIntegral_RpowK(int na, int la, int nb, int lb, int k) {
  ...
  {
    //     double Iquad = 0;
    double Norm = 2 * sqrt(tgamma(na + 1) * tgamma(nb + 1) /
                           tgamma(na + la + 1.5) / tgamma(nb + lb + 1.5));
    //     double Norm = 2*sqrt(
    //     gsl_sf_gamma(na+1)*gsl_sf_gamma(nb+1)/gsl_sf_gamma(na+la+1.5)/gsl_sf_gamma(nb+lb+1.5))
    //     ; int npoints = 50; int npoints =
    //     std::min(50,na+nb+(la+lb+1+k)/2+10000); int poly_order =
    //     na+nb+(la+lb+1+k)/2+1; int npoints = std::min(50, 2*poly_order-1);
    int npoints = 200;  // current options for npoints are 0-50, 100, and 200.
                        //     double I1=0;
                        //     double I2 = 0;
    for (int i = 0; i < npoints; i++) {
      ...
      double f_i = Norm * 0.5 * gsl_sf_laguerre_n(na, la + 0.5, x_i) *
                   gsl_sf_laguerre_n(nb, lb + 0.5, x_i) *
                   pow(x_i, 0.5 * (la + lb + 1 + k));
      I += w_i * f_i;
    }
  }
...
double RadialIntegral_Gauss(int na, int la, int nb, int lb, double sigma) {
  ...
  double kappa =
      1.0 / (2 * sigma *
             sigma);  // Gaussian exp( -x^2 / (2 sigma^2)) =>  exp(-kappa x^2)

  //   if (pmax < 20 )
  //   {
  for (int p = pmin; p <= pmax; ++p) {
    //        I += TalmiB(na,la,nb,lb,p) * TalmiI(p,k);
    I += TalmiB(na, la, nb, lb, p) *
         pow(1 + kappa, -(p + 1.5));  // Talmi integral is analytic
  }
  //   }
  return I;
}
...
/// This is valid for (2p+3+k) > 0. The Gamma function diverges for non-positive
/// integers.
long double TalmiI(int p, double k) {
  ...
  return exp(
      lgamma(p + 1.5 + 0.5 * k) -
      lgamma(p +
             1.5));  // Tested that this agrees with the boost version to better
                     // than 1 in 10^12. Also stable against overflow.
}

/// Calculate B coefficient for Talmi integral. Formula given in Brody and
/// Moshinsky "Tables of Transformation Brackets for Nuclear Shell-Model
/// Calculations"
long double TalmiB(int na, int la, int nb, int lb, int p) {
  ...
  //   double B1 = AngMom::phase(p-q) * exp(lgamma(2*p+2)-lgamma(p+1)) /
  //   pow(2,(na+nb))
  //               *
  //               exp(0.5*(lgamma(na+1)+lgamma(nb+1)-lgamma(na+la+1)-lgamma(nb+lb+1)
  //   double B1 = AngMom::phase(p-q) * exp(lgamma(2*p+2)-lgamma(p+1) +0.5*(
  //   lgamma(na+1)+lgamma(nb+1)-lgamma(na+la+1)-lgamma(nb+lb+1) +
  //   lgamma(2*na+2*la+2) + lgamma(2*nb+2*lb+2)) - (na+nb)*log(2)   ) ;
  long double logB1 =
      (lgamma(2 * p + 2) - lgamma(p + 1) +
       0.5 * (lgamma(na + 1) + lgamma(nb + 1) - lgamma(na + la + 1) -
              lgamma(nb + lb + 1) + lgamma(2 * na + 2 * la + 2) +
              lgamma(2 * nb + 2 * lb + 2)) -
       (na + nb) * LOG2);
  //               *
  //               exp(0.5*(lgamma(na+1)+lgamma(nb+1)-lgamma(na+la+1)-lgamma(nb+lb+1)
  //                     + lgamma(2*na+2*la+2) + lgamma(2*nb+2*lb+2)) );
  //               * sqrt(  exp(lgamma(na+1)) * exp(lgamma(nb+1)) /
  //               exp(lgamma(na+la+1))/ exp(lgamma(nb+lb+1))
  //                     * exp(lgamma(2*na+2*la+2)) * exp(lgamma(2*nb+2*lb+2))
  //                     );
  //              * sqrt(
  //              gsl_sf_fact(na)*gsl_sf_fact(nb)/gsl_sf_fact(na+la)/gsl_sf_fact(nb+lb)
  ...
  for (int k = kmin; k <= kmax; ++k) {
    //      B2  += exp(lgamma(la+k+1)-lgamma(k+1) +lgamma(p-(la-lb)/2-k+1)
    //      -lgamma(2*p-la+lb-2*k+2) )
    //             / (  gsl_sf_fact(2*la+2*k+1) * gsl_sf_fact(na-k)
    //                * gsl_sf_fact(nb - p + q + k) * gsl_sf_fact(p-q-k) );
    B2 += exp(logB1 + lgamma(la + k + 1) - lgamma(k + 1) +
              lgamma(p - (la - lb) / 2 - k + 1) -
              lgamma(2 * p - la + lb - 2 * k + 2) - lgamma(2 * la + 2 * k + 2) -
              lgamma(na - k + 1) - lgamma(nb - p + q + k + 1) -
              lgamma(p - q - k + 1));
  }
...
long double TalmiB_SingleTerm(int na, int la, int nb, int lb, int p, int K) {
  ...
  //             / (  gsl_sf_fact(2*la+2*k+1) * gsl_sf_fact(na-k)
  //                * gsl_sf_fact(nb - p + q + k) * gsl_sf_fact(p-q-k) );
  long double B2 = exp(logB1 + lgamma(la + k + 1) - lgamma(k + 1) +
                       lgamma(p - (la - lb) / 2 - k + 1) -
                       lgamma(2 * p - la + lb - 2 * k + 2) -
...
long double TalmiB_SingleTermPair(int na, int la, int nb, int lb, int p, int K,
                                  int nu) {
  if ((la + lb) % 2 > 0) return 0;

  int q = (la + lb) / 2;
  int k = K;
  //   long double logB1 = (lgamma(2*p+2)-lgamma(p+1) +0.5*(
  //   lgamma(na+1)+lgamma(nb+1)-lgamma(na+la+1)-lgamma(nb+lb+1) +
  //   lgamma(2*na+2*la+2) + lgamma(2*nb+2*lb+2)) - (na+nb)*LOG2   ) ;
  long double logB1 =
      (0.5 * (lgamma(na + 1) + lgamma(nb + 1) - lgamma(na + la + 1) -
              lgamma(nb + lb + 1) + lgamma(2 * na + 2 * la + 2) +
              lgamma(2 * nb + 2 * lb + 2)) -
       (na + nb) * LOG2);
  logB1 += lgamma(la + K + 1) - lgamma(k + 1) - lgamma(2 * la + 2 * k + 2) -
           lgamma(na - k + 1);
  logB1 += -lgamma(p + 1) - lgamma(na + k + (la + lb) / 2 - p + 1);

  long double B2 =
      factorial_ratio(2 * p + 1, 2 * p + 1 - la - lb - 2 * k) *
      factorial_ratio(p - k - (la - lb) / 2, p - k - (la + lb) / 2);
  long double B3 = 1.0 - (2 * p + 3) * (nb + k + (la + lb) / 2 - p) /
                             (2 * p + 3 - la + lb - 2 * k) /
                             (p + 1 - k - (la + lb) / 2) * (2 * p + 3 + nu) /
                             (p + 3);
  //   long double B2 = 0;
  //   int kmin = std::max(0, p-q-nb);
  //   int kmax = std::min(na, p-q);
  ...
  //                * gsl_sf_fact(nb - p + q + k) * gsl_sf_fact(p-q-k) );
  //   long double B2  = exp(logB1+lgamma(la+k+1)-lgamma(k+1)
  //   +lgamma(p-(la-lb)/2-k+1) -lgamma(2*p-la+lb-2*k+2)
  //                - lgamma(2*la+2*k+2) -lgamma(na-k+1)
  //                - lgamma(nb - p + q + k+1) - lgamma(p-q-k+1) );
  //   }
...
/// Note that there is a literature convention to include the 1/sqrt(Lambda)
/// factor in the reduced matrix element rather than in the expression involving
/// the sum over one-body densities (see footnote on pg 165 of Suhonen). I do
/// not follow this convention, and instead produce the reduced matrix element
...
Operator AllowedGamowTeller_Op(ModelSpace& modelspace) {
  ...
  for (int i = 0; i < norbits; ++i) {
    ...
    for (int j : GT.OneBodyChannels[{oi.l, oi.j2, oi.tz2}]) {
      ...
      double sixj =
          modelspace.GetSixJ(0.5, 0.5, 1.0, oj.j2 / 2., oi.j2 / 2., oi.l);
      double M_gt = 2 * modelspace.phase(oi.l + oi.j2 / 2.0 + 1.5) *
                    sqrt((oi.j2 + 1) * (oj.j2 + 1)) * sqrt(1.5) * sixj;
      GT.OneBody(i, j) = M_gt;
    }
  }
  return GT;
...
Operator Sigma_Op_pn(ModelSpace& modelspace, std::string pn) {
  ...
  for (size_t i = 0; i < norbits; ++i) {
    ...
    for (auto j : Sig.OneBodyChannels[{oi.l, oi.j2, oi.tz2}]) {
      ...
      double sixj =
          modelspace.GetSixJ(0.5, 0.5, 1.0, oj.j2 / 2., oi.j2 / 2., oi.l);
      double M_sig = 2 * modelspace.phase(oi.l + oi.j2 / 2.0 + 1.5) *
                     sqrt((oi.j2 + 1) * (oj.j2 + 1)) * sqrt(1.5) * sixj;
...
Operator RadialOverlap(ModelSpace& modelspace) {
  ...
  for (index_t i = 0; i < norb; ++i) {
    ...
    for (index_t j = 0; j < norb; ++j) {
      Orbit& oj = modelspace.GetOrbit(j);
      OVL.OneBody(i, j) = RadialIntegral(
          oi.n, oi.l, oj.n, oj.l,
          0);  // This is not quite right. Only works for li+lj=even.
    }
  }
  return OVL;
}
  ...
  /*
     ...
     for (unsigned int i=0; i<norb; ++i)
     {
        ...
        for (auto j : LCM.OneBodyChannels.at({oi.l, oi.j2, oi.tz2}) )
        {
           ...
           double Lij = modelspace.phase(oi.l + (oj.j2+3)/2) *
     sqrt(oi.j2+1)*sqrt(oj.j2+1)  * sqrt(oi.l*(oi.l+1)*(2*oi.l+1)) *
     modelspace.GetSixJ(oi.l,oj.l,1,oj.j2/2.,oi.j2/2.,0.5); LCM.OneBody(i,j) =
     Lij; LCM.OneBody(j,i) = modelspace.phase((oi.j2-oj.j2)/2) * Lij;
        }
     }
...
// < ij J || Q * Q || kl J > where Q is the quadrupole operator (possibly up to
// overall factors like square roots of pi, etc...)
Operator QdotQ_Op(ModelSpace& modelspace) {
  ...
  Operator E2op = ElectricMultipoleOp(modelspace, 2) +
                  NeutronElectricMultipoleOp(modelspace, 2);
  ...
  for (int ch = 0; ch < nchan; ++ch) {
    ...
    for (int ibra = 0; ibra < nkets; ++ibra) {
      ...
      for (int iket = ibra; iket < nkets; ++iket) {
        ...
        // Suhonen (8.56)
        double Aijkl = modelspace.phase(ji + jj + J) *
                       modelspace.GetSixJ(ji, jj, J, jl, jk, 2) * Qmat(k, i) *
                       Qmat(j, l);
        double Aijlk = modelspace.phase(ji + jj + J) *
                       modelspace.GetSixJ(ji, jj, J, jk, jl, 2) * Qmat(l, i) *
                       Qmat(j, k);
        //            double Aijlk = modelspace.phase(jk+jl+J) *
        //            modelspace.phase(ji+jj+J) *
        //            modelspace.GetSixJ(ji,jj,J,jk,jl,2) * Qmat(l,i) *
        //            Qmat(j,k);
        ...
        if (tbc.Tz == 0)  // proton-neutron channel
        {
          if (oi.tz2 == ok.tz2)
            ...
            QdQ = -modelspace.phase(jk + jl + J) * Aijlk;  // pnnp
        } else {
...
Operator VCentralCoulomb_Op(ModelSpace& modelspace,
                            int lmax)  // default lmax=99999
{
  //   std::cout << "Making VCentralCoulomb_Op. lmax is " << lmax  << std::endl;
  Operator VCoul(modelspace, 0, 0, 0, 2);
  double oscillator_b =
      sqrt(HBARC * HBARC / M_NUCLEON / modelspace.GetHbarOmega());
  ...
  VCoul.OneBody *=
      ALPHA_FS * HBARC /
      oscillator_b;  // convert from oscillator units to fermi. ALPHA_FS ~ 1/137
                     // is the fine structure constant
  //   VCoul.OneBody *= alpha_FS * HBARC / oscillator_b; // convert from
  //   oscillator units to fermi std::cout << "Oscillator b = " << oscillator_b
  //   << std::endl; std::cout << "One body part done. it looks like" <<
  //   std::endl << VCoul.OneBody << std::endl;
  return VCoul;
}
...
Operator VCoulomb_Op(ModelSpace& modelspace, int lmax)  // default lmax=99999
{
  ...
  for (int na = 0; na <= nmax; na++) {
    for (int nb = 0; nb <= na; nb++) {
      for (int l = 0; l <= lrelmax; l++) {
        ...
        size_t flip_hash =
            nb * (nmax + 1) * (lrelmax + 1) + na * (lrelmax + 1) + l;
  ...
  //   std::cout << "now the big loop... lrelmax = " << lrelmax << "  size of
  //   RadInt = " << RadialIntegrals.size()  << std::endl;
  ...
  double sa, sb, sc, sd;
  sa = sb = sc = sd = 0.5;
  //   #pragma omp parallel for schedule(dynamic,1)  // It would appear that
  //   something's not thread-safe in this routine...
  for (int ch = 0; ch < nchan; ++ch) {
    TwoBodyChannel& tbc = modelspace.GetTwoBodyChannel(ch);
    ...
    for (int ibra = 0; ibra < nkets; ++ibra) {
      ...
      int la = oa.l;
      int lb = ob.l;
      //         std::cout << "ibra = " << ibra << "  a,b   la,lb = " << bra.p
      //         << " " << bra.q << "    " << la << " " <<lb << std::endl;
      double ja = oa.j2 * 0.5;
      double jb = ob.j2 * 0.5;
      int fab = 2 * na + 2 * nb + la + lb;
      ...
      for (int iket = ibra; iket < nkets; ++iket) {
        ...
        for (int Lab = std::abs(la - lb); Lab <= la + lb; ++Lab) {
          for (int Sab = 0; Sab <= 1; ++Sab) {
            ...
            double njab =
                AngMom::NormNineJ(la, sa, ja, lb, sb, jb, Lab, Sab, J);
            if (std::abs(njab) < 1e-7) continue;
            int Scd = Sab;
            int Lcd = Lab;
            double njcd =
                AngMom::NormNineJ(lc, sc, jc, ld, sd, jd, Lcd, Scd, J);
            if (std::abs(njcd) < 1e-7) continue;
            // Next, transform to rel / com coordinates with Moshinsky
            // tranformation
            for (int N_ab = 0; N_ab <= fab / 2; ++N_ab)  // N_ab = CoM n for a,b
            {
              for (int Lam_ab = 0; Lam_ab <= fab - 2 * N_ab;
                   ++Lam_ab)  // Lam_ab = CoM l for a,b
              {
                int Lam_cd = Lam_ab;  // 1/r conserves lam and Lam, ie relative
                                      // and com orbital angular momentum
                for (int lam_ab = (fab - 2 * N_ab - Lam_ab) % 2;
                     lam_ab <= (fab - 2 * N_ab - Lam_ab);
                     lam_ab += 2)  // lam_ab = relative l for a,b
                {
                  if (Lab < std::abs(Lam_ab - lam_ab) or
                      Lab > (Lam_ab + lam_ab))
                    continue;
                  ...
                  double mosh_ab = modelspace.GetMoshinsky(
                      N_ab, Lam_ab, n_ab, lam_ab, na, la, nb, lb, Lab);
                  if (std::abs(mosh_ab) < 1e-8) continue;
                  ...
                  double prefactor =
                      njab * njcd * mosh_ab * mosh_cd * asymm_factor;

                  size_t hash = n_ab * (nmax + 1) * (lrelmax + 1) +
                                n_cd * (lrelmax + 1) + lam_ab;
                  if (RadialIntegrals.find(hash) == RadialIntegrals.end()) {
                    std::cout
                        << "AAAHHH!!!  trying to access radial integral for "
                        << n_ab << " " << n_cd << " " << lam_ab
                        << "    and it's not there!!!!" << std::endl;
                  }
        ...
        // In Moshinsky's convention, r_rel = (r1-r2)/sqrt(2).  We want
        // 1/|r1-r2| = 1/sqrt(2) * 1/r_rel
        rinv *=
            1 / sqrt(2 * (1.0 + bra.delta_pq()) *
                     (1.0 + ket.delta_pq()));  // normalize and account for
                                               // sqrt(2) Moshinsky convention
        VCoul.TwoBody.SetTBME(ch, ibra, iket, rinv);
        VCoul.TwoBody.SetTBME(ch, iket, ibra, rinv);
      }
    }
  }
  VCoul *= ALPHA_FS * HBARC /
           oscillator_b;  // convert to MeV.  V = e^2/r = alpha*hc / r

  //   std::cout << "All done with VCoul." << std::endl;
  //   std::cout << "0s pp,pn,nn: " << VCoul.TwoBody.GetTBME_J(0,0, 0,0, 0,0) <<
  //   " " << VCoul.TwoBody.GetTBME_J(0,0, 1,0, 1,0) << " " <<
  //   VCoul.TwoBody.GetTBME_J(0,0, 1,1, 1,1) << std::endl;
...
Operator AxialCharge_Op(ModelSpace& modelspace) {
  ...
  double oscillator_b =
      HBARC * HBARC / sqrt(M_NUCLEON * modelspace.GetHbarOmega());
  for (auto a : modelspace.all_orbits) {
    Orbit& oa = modelspace.GetOrbit(a);
    double prefactor = modelspace.phase((oa.j2 + 1) / 2) *
                       sqrt((oa.j2 + 1.0) * 6.0 / 4 / M_PI);
    std::cout << " a = " << a
              << " size of one body channels = " << AxCh.OneBodyChannels.size()
              << " pre: " << (oa.j2 + 1) / 2 << "  "
              << sqrt((oa.j2 + 1.0) * 6.0 / 4 / M_PI) << "  " << prefactor
              << std::endl;
    std::cout << " OBC.at(a) : ";
    ...
    for (auto b : AxCh.OneBodyChannels.at({oa.l, oa.j2, oa.tz2})) {
      ...
      double radialint =
          imsrg_util::RadialIntegral_RpowK(oa.n, oa.l, ob.n, ob.l, 1);
      std::cout << "prefactor " << prefactor << "   sixj " << sixj
                << "   threej " << threej << "   radialint " << radialint
                << "  b " << oscillator_b << std::endl;
      AxCh.OneBody(a, b) = prefactor * sixj * threej * radialint / oscillator_b;
    }
  }

  std::cout << "AxialCharge 1b looks like" << std::endl
            << AxCh.OneBody << std::endl
            << std::endl;

  return AxCh;
}

Operator WoodsSaxon1b_Op(ModelSpace& modelspace, double V0, double R0,
                         double a0) {
  Operator VWS_op(modelspace, 0, 0, 0,
                  2);  // This should just be a 1b operator...
  ...
  for (int igrid = 0; igrid < ngrid; igrid++)
    Vgrid[igrid] = V0 / (1.0 + exp((rgrid[igrid] - R0) / a0));

  for (auto a : modelspace.all_orbits) {
    Orbit& oa = modelspace.GetOrbit(a);
    for (int igrid = 0; igrid < ngrid; igrid++)
      psi_a[igrid] = HO_Radial_psi(oa.n, oa.l, hw, rgrid[igrid]);
    for (auto b : VWS_op.OneBodyChannels.at({oa.l, oa.j2, oa.tz2})) {
      ...
      for (int igrid = 0; igrid < ngrid; igrid++) {
        ...
        Vab += psi_a[igrid] * psi_b_r * Vgrid[igrid] * rgrid[igrid] *
               rgrid[igrid] * dr;
      }
...
Operator HOtrap_Op(ModelSpace& modelspace, double hw_trap) {
  Operator VHO_op(modelspace, 0, 0, 0,
                  2);  // This should just be a 1b operator...
  ...
  for (int igrid = 0; igrid < ngrid; igrid++) rgrid[igrid] = dr * igrid;
  for (int igrid = 0; igrid < ngrid; igrid++)
    Vgrid[igrid] = 0.5 * rgrid[igrid] * rgrid[igrid] / bosc2 * hw_trap;
...
// < A | adagger | A-1> = 1 + 1/2 sum_abi |V_piab|^2 * (
// 1/(ep+ei-ea-eb)+1/(ep))/(2ep+ei-ea-eb)
//                          - 1/2 sum_aij |V_apij|^2 * 1/( ep*(ei+ej-ea-eb) )
//
//          when doing the j coupled version, the Vpiab term gets a 2J+1/2ji+1
//          and the Vapij gets 2J+1/2ja+1 The spectroscopic factor is then the
//          reduced matrix element squared which gives SF = 2jp+1 |amplitude|^2
//
double MBPT2_SpectroscopicFactor(Operator H, index_t p) {
  ...
  for (auto p : H.modelspace->all_orbits)
    std::cout << p << " :  " << H.OneBody(p, p) << std::endl;
  ...
  for (auto a : H.modelspace->particles) {
    ...
    for (auto i : H.modelspace->holes) {
      ...
      for (auto b : H.modelspace->particles) {
        ...
        int Jmin =
            std::max(std::abs(oa.j2 - ob.j2), std::abs(oi.j2 - op.j2)) / 2;
        int Jmax = std::min(oa.j2 + ob.j2, oi.j2 + op.j2) / 2;
        double Jterm = 0;
        for (int J = Jmin; J <= Jmax; J++) {
          // GetTBME_J returns an unnormalized matrix element, which is what I
          // want.
          double Vpiab = H.TwoBody.GetTBME_J(J, p, i, a, b);
          Jterm += 0.5 * (2 * J + 1.) / (oi.j2 + 1) * Vpiab * Vpiab *
                   (1.0 / (ep + ei - ea - eb - ef) + 1.0 / ep) /
                   (2 * ep + ei - ea - eb);
          amplitude += 0.5 * (2 * J + 1.) / (oi.j2 + 1) * Vpiab * Vpiab *
                       (1.0 / (2 * ep + ei - ea - eb - ef) + 1.0 / ep) /
                       (ep + ei - ea - eb);
        }
        std::cout << "i,a,b, " << i << " " << a << " " << b << " spes  " << ei
                  << " " << ea << " " << eb << "  denominator  "
                  << (1.0 / (2 * ep + ei - ea - eb - ef) + 1.0 / ep) /
                         (ep + ei - ea - eb)
                  << "  contribution  " << Jterm << std::endl;
      }
      for (auto j : H.modelspace->holes) {
        Orbit& oj = H.modelspace->GetOrbit(j);
        double ej = H.OneBody(j, j);
        int Jmin =
            std::max(std::abs(oa.j2 - op.j2), std::abs(oi.j2 - oj.j2)) / 2;
        int Jmax = std::min(oa.j2 + op.j2, oi.j2 + oj.j2) / 2;
        double Jterm = 0;
        for (int J = Jmin; J <= Jmax; J++) {
          double Vpaij = H.TwoBody.GetTBME_J(J, p, a, i, j);
          Jterm -= 0.5 * (2 * J + 1.) / (oa.j2 + 1) * Vpaij * Vpaij * 1.0 /
                   ((ep - ef) * (ei + ej - ea - ef));
          amplitude -= 0.5 * (2 * J + 1.) / (oa.j2 + 1) * Vpaij * Vpaij * 1.0 /
                       ((ep - ef) * (ei + ej - ea - ef));
        }
        std::cout << "i,j,a " << i << " " << j << " " << a << " spes  " << ei
                  << " " << ej << " " << ea << "  denominator  "
                  << 1.0 / ((ep - ef) * (ei + ej - ea - ef))
                  << "   contribution  " << Jterm << std::endl;
      }
    }
  }
...
namespace atomic_fs {  // operators related to fine structure

Operator Darwin(ModelSpace& modelspace, int Z) {
  double constants = PI * Z * ALPHA_FS * HBARC * HBARC * HBARC /
                     (2 * M_ELECTRON * M_ELECTRON * 1e6 *
                      1e6);  // convert to eV and nanometers.
  Operator Hdarwin(modelspace, 0, 0, 0, 2);
  for (auto a : modelspace.all_orbits) {
    Orbit& oa = modelspace.GetOrbit(a);
    double wf0_a =
        imsrg_util::HO_Radial_psi(oa.n, oa.l, modelspace.GetHbarOmega(), 0.0);
    if (oa.l != 0) continue;  // no spin-orbit in s-wave
    for (auto b : Hdarwin.OneBodyChannels.at({oa.l, oa.j2, oa.tz2})) {
      Orbit& ob = modelspace.GetOrbit(b);
      double wf0_b =
          imsrg_util::HO_Radial_psi(ob.n, ob.l, modelspace.GetHbarOmega(), 0.0);
...
Operator RelativisticT(ModelSpace& modelspace) {
  Operator Hrel =
      imsrg_util::KineticEnergy_RelativisticCorr(modelspace) * 1e6 * M_NUCLEON /
      (M_ELECTRON);  // change to electron mass, as use eV rather than MeV.
  return Hrel;
}
...
Operator SpinOrbit(ModelSpace& modelspace, int Z) {
  ...
  double oscillator_b =
      sqrt(HBARC * HBARC / (1e6 * M_ELECTRON) /
           modelspace.GetHbarOmega());  // convert energies to eV, and lengths
                                        // to nanometers
  ...
  //     double constants = Z*ALPHA_FS * HBARC*HBARC * gspin /
  //     (M_ELECTRON*M_ELECTRON*1e6*1e6) / 32;  // it's 1/8, but we use 4 *
  //     LdotS, so 1/32.
  double constants = Z * ALPHA_FS * HBARC * HBARC * ELECTRON_SPIN_G /
                     (M_ELECTRON * M_ELECTRON * 1e6 * 1e6) /
                     32;  // it's 1/8, but we use 4 * LdotS, so 1/32.
  for (auto a : modelspace.all_orbits) {
    Orbit& oa = modelspace.GetOrbit(a);
    if (oa.l == 0) continue;  // no spin-orbit in s-wave
    ...
    for (auto b : Hso.OneBodyChannels.at({oa.l, oa.j2, oa.tz2})) {
      Orbit& ob = modelspace.GetOrbit(b);
      double r3inv =
          imsrg_util::RadialIntegral_RpowK(oa.n, oa.l, ob.n, ob.l, -3);
...
namespace atomic_hfs {  // operators related to hyperfine structure
...
// Hd = -0.5*alpha(hbarc)^3/(m_ec^2 m_pc^2) g_nuc I * [ r^-3 L  +1/2 g_s r^-3 (
// 3(\vec{s}*\hat{r})\hat{r} - \vec{s} ) + 4pi/3 gs delta(r) \vec{s} ) we
// rewrite the tensor bit as
//                                 3(s*r)r-s = -sqrt{2pi}[s^(2) x Y^(2)]^(1)
Operator hD(ModelSpace& modelspace) {
  Operator Hd(modelspace, 1, 0, 0, 2);  // J rank is 1, even parity.

  double oscillator_b = sqrt(
      HBARC * HBARC / (1e6 * M_ELECTRON) /
      modelspace
          .GetHbarOmega());  // convert energies to eV, lengths to nanometers
  double oscillator_b3 = pow(oscillator_b, 3);
  //     double alpha_FS = 1.0 / 137.035999;
  //     double gspin = 2.002319; // electron spin g factor
  //     double constants = - 0.5*alpha_FS
  //     *HBARC*HBARC*HBARC/(M_ELECTRON*M_NUCLEON*1e12);  // convert both masses
  //     to eV
  double constants = -0.5 * ALPHA_FS * HBARC * HBARC * HBARC /
                     (M_ELECTRON * M_NUCLEON * 1e6 *
                      1e6);  // convert masses to eV, lengths to nanometers
  for (auto a : modelspace.all_orbits) {
    Orbit& oa = modelspace.GetOrbit(a);
    for (auto b : modelspace.OneBodyChannels.at({oa.l, oa.j2, oa.tz2})) {
      Orbit& ob = modelspace.GetOrbit(b);
      if (oa.l == 0 and ob.l == 0) {
        double wf0_a = imsrg_util::HO_Radial_psi(
            oa.n, oa.l, modelspace.GetHbarOmega(), 0.0);
        double wf0_b = imsrg_util::HO_Radial_psi(
            ob.n, ob.l, modelspace.GetHbarOmega(), 0.0);
        // the reduced matrix element of s is <1/2|| s || 1/2> = sqrt(3/2)
        //           Hd.OneBody(a,b) = 4*PI/3 * gspin * sqrt(3./2) * wf0_a *
        //           wf0_b ;
        Hd.OneBody(a, b) =
            4 * PI / 3 * ELECTRON_SPIN_G * sqrt(3. / 2) * wf0_a * wf0_b;
        ...
        double L =
            oa.l != ob.l
                ? 0
                : sqrt((oa.j2 + 1.0) / (oa.j2 * (oa.j2 + 2))) *
                      (oa.j2 * (oa.j2 + 2.) / 4 + oa.l * (oa.l + 1) - 3. / 4);
        double T =
            modelspace.phase(oa.l) * 3 * sqrt(5) *
            sqrt((oa.j2 + 1) * (ob.j2 + 1) * (2 * oa.l + 1) * (2 * ob.l + 1)) *
            AngMom::ThreeJ(oa.l, 2, ob.l, 0, 0, 0) *
            AngMom::NineJ(oa.l, 0.5, 0.5 * oa.j2, ob.l, 0.5, 0.5 * ob.j2, 2, 1,
                          1);
...
// Kinetic energy T = T_el + T_nuc =  1/2m sum_i (p_i)^2 + 1/2M_nuc ( sum_i p_i
// )^2  =  (1/2m + 1/2M_n) sum_i (p_i)^2 + 1/2M_nuc sum_ij (p_i * p_j) The first
// correction, the 1/2M_n one-body part is responsible for what is called the
// "Normal Mass Shift", while the second correction which goes like p_i * p_j (*
// means a vector dot product here), is responsible for the "Specific Mass
// Shift".
Operator NormalMassShift(ModelSpace& modelspace, int A) {
  Operator Hnms =
      (M_ELECTRON / A / M_NUCLEON) *
      imsrg_util::KineticEnergy_Op(
          modelspace);  // kinetic energy is in units of hw, so no change needed
  if (A != modelspace.GetTargetMass())
    Hnms *= (modelspace.GetTargetMass() / double(A));
  return Hnms;
}

Operator SpecificMassShift(ModelSpace& modelspace, int A) {
  Operator Hsms = imsrg_util::TCM_Op(
      modelspace);       // TCM_Op returns a 1-body piece, plus the 1-body part
                         // pi*pj/mA. We don't want the 1-body part.
  Hsms.OneBody.zeros();  // The specific shift is just the two-body part.
  if (A != modelspace.GetTargetMass())
    Hsms *= (modelspace.GetTargetMass() / double(A));
  return Hsms;
}
...
Operator CombinedMassShift(ModelSpace& modelspace, int A) {
  ...
  if (A != modelspace.GetTargetMass())
    Hcms *= (modelspace.GetTargetMass() / double(A));
  return Hcms;
}
...
/// The function returns a one-body operator, i.e. the two-body part is not
/// computed. Formula is \f{equation}{
///  \langle p \| O^{\lambda} \| q \rangle = -\sum_{ia} (n_i -na) \sum_{J}(2J+1)
///  \begin{Bmatrix}
///    j_i & j_a & \lambda \\
///    j_p & j_q & J
///  \end{Bmatrix}
///   \langle i \| O^{\lambda} \| a \rangle \frac{
///   \tilde{\Gamma}^{J}_{paiq}}{\Delta_{paiq}}
/// \f}
//
...
Operator FirstOrderCorr_1b(const Operator& OpIn, const Operator& H) {
  ...
  for (auto p : OpIn.modelspace->valence) {
    ...
    for (auto q : OpIn.OneBodyChannels.at({op.l, op.j2, op.tz2})) {
      if (std::find(OpIn.modelspace->valence.begin(),
                    OpIn.modelspace->valence.end(),
                    q) == OpIn.modelspace->valence.end())
        continue;
      ...
      for (size_t i = 0; i < norb; i++) {
        ...
        for (auto a : OpIn.OneBodyChannels.at({oi.l, oi.j2, oi.tz2})) {
          ...
          int Jmin = std::max(std::max(std::abs(jp - ja), std::abs(ji - jq)),
                              std::max(std::abs(jp - ji), std::abs(ja - jq)));
          int Jmax =
              std::max(std::min(jp + ja, ji + jq), std::min(jp + ji, ja + jq));
          //           double Delta_paiq = H.OneBody(p,p) + H.OneBody(a,a) -
          //           H.OneBody(i,i) - H.OneBody(q,q);
          double Delta_qipa = H.OneBody(q, q) + H.OneBody(i, i) -
                              H.OneBody(p, p) - H.OneBody(a, a);
          ...
          for (int J = Jmin; J <= Jmax; J++) {
            ...
            //             double Gamma_paiq =
            //             H.TwoBody.GetTBME_J_norm(J,p,a,i,q);
            gbar -= (2 * J + 1) * sixj * Gamma_paiq;
            //             if ( p==2 and q==2 and a==6 and i==0)
            //             {
            //                std::cout << " line " <<__LINE__ << "  J=" << J <<
            //                "  :  " << (2*J+1) << " * " << sixj << " * " <<
            //                Gamma_paiq << "  =>  " << gbar << std::endl;
            //             }
          }
...
//
//
//   The n-th order TDA contribution is  TODO this is still not right in the
//   comment. Work this out cleanly.
//
//   <p|| O(TDA,n) ||q> = sum_{a,b,...c,d}  sum_{i,j,...k,l}  [ G_pq`ia` /
//   Del_qipa ]
//                                                         * [G_ia`jb` /
//                                                         Del_qjpb ] * ...
//                                                         *[G_kc`ld` /
...
//                                                         *[G_kc`ld` /
//                                                         Del_plqd] * <d||O||l>
//   G_ia`jb` is the Pandya-Transformed interaction,and Del is the energy
//   denomonator Del_ijkl = ei + ej - ek -el
//
////// I Think this way is wrong. It assumes some symmetries that don't seem to
///hold.
/*
 Operator RPA_resummed_1b( const Operator& OpIn, const Operator& H, std::string
 mode )
 {
   ...
   for ( auto h : OpIn.modelspace->holes )
   {
     ...
     for (auto p : OpIn.modelspace->particles )
     {
       ...
       if ( (oh.j2 + op.j2)<2*Lambda or std::abs(oh.j2-op.j2)>2*Lambda)
 continue; if ( (oh.l + op.l + OpIn.GetParity())%2 > 0 ) continue; if (
 std::abs( oh.tz2 - op.tz2) != 2*std::abs(OpIn.GetTRank())) continue;
   ...
   if (mode=="RPA")
   {
     Mphhp = GetPH_transformed_Gamma( ph_kets, hp_kets, H, Lambda );
      ...
      // we need a phase because we multiply this by Oph, which differs from Ohp
 by (-1)^{jp-jh}. arma::Row<double> phases(nkets, arma::fill::ones); for (
 size_t i=0; i<nkets; i++) phases(i) = ph_phase[i]; Mphhp.each_row() %= phases;

   }
   if ( mode=="CP" ) // CP means first order core-polarization correction. M is
 zero because we don't want the iterations.
   {
     Mphph.zeros();
   }
  ...
  // At this point, we can't get around the fact that the denominators depend on
 the initial and final state of the
  // entire operator, as in < p | Oeff | q >, and we need to add ep-eq to the
 denominator. So for every p,q pair
  // we need to do the matrix inversion and evaluation in 1st order PT.
   ...
   for ( auto v1 : OpIn.modelspace->valence )
   {
     for ( auto v2 : OpIn.modelspace->valence )
     {
      ...
      // evaluate this in first order perturbation theory, and take the valence
 part that we're interested in double op12 = FirstOrderCorr_1b( OpRPA,
 H).OneBody(v1,v2); OpOut.OneBody(v1,v2) += op12;
...
Operator RPA_resummed_1b(const Operator& OpIn, const Operator& H,
  ...
  for (size_t i = 0; i < nkets; i++) {
    ...
    //     std::cout << " setting  i " << i << "  ph " << p << " " << h << " Oph
    //     " << Oph(i) << "  Ohp " << Ohp(i) << std::endl;
  }
  ...
  //   std::cout << "Size of Mphph is " << Mphph.n_rows << " x " << Mphph.n_cols
  //   << std::endl;
  ...
  //   std::cout << "Mphph is " << std::endl << Mphph << std::endl << std::endl
  //   << "Delta is " << std::endl << Delta << std::endl << "Oph is " <<
  //   std::endl << Oph << std::endl << "Mphph*Oph is " << std::endl << tmp <<
  //   std::endl;
  ...
  // At this point, we can't get around the fact that the denominators depend on
  // the initial and final state of the entire operator, as in < p | Oeff | q >,
  // and we need to add ep-eq to the denominator. So for every p,q pair we need
  // to do the matrix inversion and evaluation in 1st order PT.
  ...
  for (auto v1 : OpIn.modelspace->valence) {
    for (auto v2 : OpIn.modelspace->valence) {
      ...
      //      arma::mat del12 = arma::ones(arma::size(Delta)) *
      //      (H.OneBody(v1,v1) - H.OneBody(v2,v2)) ;
      arma::mat del12(arma::size(Delta));
      del12.fill(H.OneBody(v1, v1) - H.OneBody(v2, v2));
      del12.cols(nkets, 2 * nkets - 1) *= -1;
      // do the fancy resummation of the series by matrix inversion
      // Minv  =  (I-M)^-1  where I is the identity matrix. The slash here means
      // element-wise division.
      arma::mat Minv =
          arma::inv(arma::eye(arma::size(M)) - M / (Delta + del12));

      //       arma::mat Mdel = M/(Delta+del12); // FOR DEBUGGING. REMOVE THIS
      //       Minv = arma::eye(arma::size(M)) + Mdel;// + Mdel*Mdel;   // FOR
      //       DEBUGGING. REMOVE THIS
      arma::vec ORPA = Minv * Ovec;

      //       arma::mat mphph_tmp = Mphph/(Delta.submat(0,0,nkets-1,nkets-1) +
      //       del12.submat(0,0,nkets-1,nkets-1) ); arma::mat mhphp_tmp =
      //       Mhphp/(Delta.submat(nkets,nkets,2*nkets-1,2*nkets-1) +
      //       del12.submat(nkets,nkets,2*nkets-1,2*nkets-1) ); arma::mat
      //       mphhp_tmp = Mphhp/(Delta.submat(0,nkets,nkets-1,2*nkets-1) +
      //       del12.submat(0,nkets,nkets-1,2*nkets-1) ); arma::mat mphhp_alt =
      //       mphhp_tmp; arma::Row<double> phases(nkets, arma::fill::ones); for
      //       ( size_t i=0; i<nkets; i++) phases(i) = ph_phase[i];
      //       mphhp_alt.each_row() %= phases;
      //
      ////       std::cout << "mphhp_tmp = " << std::endl << mphhp_tmp <<
      ///std::endl << std::endl << " mphhp_alt = " << std::endl << mphhp_alt <<
      ///std::endl;
      //       arma::mat mhpph_tmp =
      //       Mhpph/(Delta.submat(nkets,0,2*nkets-1,nkets-1) +
      //       del12.submat(nkets,0,2*nkets-1,nkets-1) ); arma::vec Orpa_ph =
      //       mphph_tmp * Oph + mphhp_tmp * Ohp; arma::vec Orpa_ph_alt =
      //       (mphph_tmp + mphhp_alt) * Oph; arma::vec Orpa_hp = mhphp_tmp *
      //       Ohp + mhpph_tmp * Oph;

      //       std::cout << "====================================  " << v1 << "
      //       " << v2 << " ===============================" << std::endl; for
      //       (size_t i=0; i<Oph.n_rows;i++)
      //       {
      //          std::cout << "i " << i << "    Oph, Ohp  " << Oph(i) << "   "
      //          << Ohp(i) << "    Orpa_ph,hp " << Orpa_ph(i) << " , " <<
      //          Orpa_ph_alt(i) << "   " << Orpa_hp(i)
      //                      << "  phase " << ph_phase[i] << "       " <<
      //                      Orpa_ph(i) - ph_phase[i]*Orpa_hp(i) << std::endl;
      //       }
      // now we need to unpack ORPA into a matrix again.
      Operator OpRPA = OpIn;
      OpRPA.OneBody.zeros();
      for (size_t i = 0; i < nkets; i++) {
        size_t p = ph_kets[i].first;
        size_t h = ph_kets[i].second;
        // This is risky business, if in the future we assume some symmetries
        // about these matrix elements. We have symmetry for  v1 <-> v2, but we
        // don't have a symmetry for p <-> h for a fixed v1,v2.
        ...
        //          std::cout << "i " << i << "   ph " << p << "  " << h << "
        //          Oph " << OpRPA.OneBody(p,h) << "   Ohp " <<
        //          OpRPA.OneBody(h,p) << std::endl;
        //         OpRPA.SetOneBody(p,h,  ORPA(i) ) ;
        //          std::cout << "  " << i << "   ph " << p << "  " << h << "
        //          Oph " << OpRPA.OneBody(p,h) << "   Ohp " <<
        //          OpRPA.OneBody(h,p) << std::endl;
      ...
      //           double ja = oa.j2*0.5;
      //           double ji = oi.j2*0.5;
      //           int Jmin = std::max( std::abs(ov1.j2-oa.j2),
      //           std::abs(ov2.j2-oi.j2))/2; int Jmax = std::min(
      //           (ov1.j2+oa.j2), (ov2.j2+oi.j2))/2; double gbar1up = 0; for
      //           (int J=Jmin; J<=Jmax; J++)
      //           {
      //             gbar1up -= (2*J+1) * OpIn.modelspace->GetSixJ( jv1, ja, J,
      //             ji, jv2, Lambda) * H.TwoBody.GetTBME_J(J,v1,a,i,v2);
      //           }
      //           double denom1up = H.OneBody(v2,v2) + H.OneBody(i,i) -
      //           H.OneBody(v1,v1) - H.OneBody(a,a);
      //
      //           Jmin = std::max( std::abs(ov1.j2-oi.j2),
      //           std::abs(ov2.j2-oa.j2))/2; Jmax = std::min( (ov1.j2+oi.j2),
      //           (ov2.j2+oa.j2))/2; double gbar1down = 0; for (int J=Jmin;
      //           J<=Jmax; J++)
      //           {
      //             gbar1down -= (2*J+1) * OpIn.modelspace->GetSixJ( jv1, ji,
      //             J, ja, jv2, Lambda) * H.TwoBody.GetTBME_J(J,v1,i,a,v2);
      //           }
      //           double denom1down = H.OneBody(v1,v1) + H.OneBody(i,i) -
      //           H.OneBody(v2,v2) - H.OneBody(a,a);
      //
      ...
      //           {
      //           std::cout << " i,a = " << i << " " << a << "   tda1up " <<
      //           gbar1up << " / " << denom1up << " * " << OpIn.OneBody(i,a) <<
      //           " = " << gbar1up/denom1up * OpIn.OneBody(i,a) << std::endl;
      //           std::cout << "       " << i << " " << a << "   tda1down " <<
      //           gbar1down << " / " << denom1down << " * " <<
      //           OpIn.OneBody(a,i) << " = " << gbar1down/denom1down *
      //           OpIn.OneBody(a,i) << std::endl;
      //            }
      //
      ...
      //                double jb = ob.j2*0.5;
      //                double jj = oj.j2*0.5;
      //                int Jpmin = std::max( std::abs(oi.j2-ob.j2),
      //                std::abs(oj.j2-oa.j2))/2; int Jpmax = std::min(
      //                (oi.j2+ob.j2), (oj.j2+oa.j2))/2; double gbar2up = 0; for
      //                (int Jp=Jpmin; Jp<=Jpmax; Jp++)
      //                {
      //                  gbar2up -= (2*Jp+1) * OpIn.modelspace->GetSixJ( ji,
      //                  jb, Jp, jj, ja, Lambda) *
      //                  H.TwoBody.GetTBME_J(Jp,i,b,j,a);
      //                }
      //                double denom2up = H.OneBody(v2,v2) + H.OneBody(j,j) -
      //                H.OneBody(v1,v1) - H.OneBody(b,b);
      //
      //                Jpmin = std::max( std::abs(oi.j2-ob.j2),
      //                std::abs(oj.j2-oa.j2))/2; Jpmax = std::min(
      //                (oi.j2+ob.j2), (oj.j2+oa.j2))/2; double gbar2down = 0;
      //                for (int Jp=Jpmin; Jp<=Jpmax; Jp++)
      //                {
      //                  gbar2down -= (2*Jp+1) * OpIn.modelspace->GetSixJ( ji,
      //                  jb, Jp, jj, ja, Lambda) *
      //                  H.TwoBody.GetTBME_J(Jp,i,b,j,a);
      //                }
      //                double denom2down = H.OneBody(v1,v1) + H.OneBody(j,j) -
      //                H.OneBody(v2,v2) - H.OneBody(b,b);
      //
      //                tda2 += (gbar1up)/denom1up * (gbar2up)/denom2up *
      //                OpIn.OneBody(j,b); tda2 += (gbar1down)/denom1down *
      //                (gbar2down)/denom2down * OpIn.OneBody(b,j);
      //              }
      //            }
      //         }
      //       }
      //       std::cout << " v1 v2 =  "<< v1 << " " << v2 << "   tda1, tda2 = "
      //       << tda1 << " " << tda2 << std::endl;
...
// Return Pandya-transformed matrix elements. Input a list of bras <pq`| a list
// of kets |rs`> and an angular momentum Lambda (as well as the Hamiltonian H
// and obtain  Gamma`_pq`rs`^Lambda = - sum_J  (2J+1)  { jp  jq  Lambda  }
// Gamma_psrq^J
//                                                     { jr  js  J       }
//
// arma::mat GetPH_transformed_Gamma( std::vector<size_t> bras,
// std::vector<size_t> kets, Operator& H, int Lambda )
arma::mat GetPH_transformed_Gamma(std::vector<std::pair<size_t, size_t>>& bras,
                                  std::vector<std::pair<size_t, size_t>>& kets,
                                  const Operator& H, int Lambda) {
...
// Evaluate <bra | r1xp2 | ket>, omitting the factor (hbar * omega) /(m *
// omega^2)
/// Returns the normalized, anti-symmetrized, J-coupled, two-body matrix element
/// of \f$ \frac{m\omega^2}{\hbar \omega} \vec{r}_1\cdot\vec{r}_2 \f$.
/// Calculational details are similar to Calculate_p1p2().
double Calculate_r1xp2(ModelSpace& modelspace, Ket& bra, Ket& ket, int Jab,
                       int Jcd) {
  Orbit& oa = modelspace.GetOrbit(bra.p);
  Orbit& ob = modelspace.GetOrbit(bra.q);
  Orbit& oc = modelspace.GetOrbit(ket.p);
             ...
             ++Lam_ab)  // Lam_ab = CoM l for a,b
        {
               ...
               lam_ab += 2)  // lam_ab = relative l for a,b
          {
            ...
            int N_cd = N_ab;
            {
              ...
              //                double lrel = 0;
              double sj_rel =
                  modelspace.GetSixJ(lam_ab, lam_cd, 1, Lcd, Lab, Lam_ab);
              double sj_cm =
                  modelspace.GetSixJ(Lam_ab, Lam_cd, 1, Lcd, Lab, lam_ab);
              double lrel = modelspace.phase(Lab + Lcd) *
                            ((2 * Lab + 1) * (2 * Lcd + 1)) * sj_rel * sj_rel *
                            sqrt(lam_ab * (lam_ab + 1) * (2 * lam_ab + 1));
              double lcm = ((2 * Lab + 1) * (2 * Lcd + 1)) * sj_cm * sj_cm *
                           sqrt(Lam_ab * (Lam_ab + 1) * (2 * Lam_ab + 1));
              r1xp2 += (lcm - lrel) * 0.5;
...
// This is an attempt to implement the contact term in the neutrinoless double
// beta decay operator presented in Cirigliano et al PRL 120 202001 (2018) I
// implemented the cutoff-regulated version given in r-space by V(r) = -2
// g_nuNN(R) delta_R(r) where delta_R is a Gaussian regulated delta function
// delta_R(r) = 1/ (sqrt(pi)R)^3 * exp(-r^2/R^2)
// for cutoff R.  This delta is normalized to 1 when integrated over x,y,x.
// So in spherical coordinates, the angular integration picks up a factor 4pi
// and the radial integration comes with r^2dr.
//  The low energy constant g_nuNN is estimated by Cirigliano et al to be order
//  fpi^-2 where fpi is the pion decay constant. To make things dimensionless,
//  we should
// After discussing with Javier Menendez, the correct thing to do is to compute
// the dimensionless quantity (r0 A^1/3) / mpi^2  * delta_R(r) Since g_nuNN is
// order fpi^-2, the combination fpi^2 * g_nuNN is a dimensionless number of
// order 1 The usual neutrino exchange matrix element has units of MeV (or
// fm^-1), but is multiplied by the nuclear radius R=1.2 A^1/3 to make it
// dimensionless (and typically of order 1). This nuclear radius factor is
// compensated in the phase space factor. So in the end, if the expectation
// value of R/fpi^2 * delta_R(r) is of order 1, it is non-negligible compared to
// the neutrino exchange operator.
Operator M0nu_contact_Op(ModelSpace& modelspace, double R0) {
  ...
  // In Moshinsky's convention, r_rel = (r1-r2)/sqrt(2).  We want ( |r1-r2|^2 /
  // R0^2 )  =  ( 2 r_rel^2 / R0^2 ) => 2 sigma^2 = R0^2/2 => sigma = R0/2
  double sigma =
      R0 / 2.0 / oscillator_b;  // we work in units of the oscillator length b
  //   double normalization = 1.0 / pow( sqrt(M_PI * R0/HBARC), 3 );
  double normalization =
      4 * PI * pow(SQRTPI * R0, -3);  // this has units fm^-3. The 4pi comes
                                      // from integration over angles
  int A = modelspace
              .GetTargetMass();  // The mass of the thing we will be calculating
  double nuclear_radius =
      1.2 *
      pow(A, 1. / 3);  // empirical estimate for nuclear radius, has units of fm
                       //   double mpi = 134.0; // pion mass, or whatever..
  //   double mpi2 = mpi*mpi / (HBARC*HBARC); // pion mass squared, in units of
  //   fm^-2, (a.k.a inverse compton wavelength squared) normalization *=
  //   nuclear_radius / mpi2; // now the normalization is dimensionless
  //
  //   double fpi = 92.2; // pion decay constant in MeV
  //   normalization *= nuclear_radius * HBARC*HBARC / (fpi*fpi); // now the
  //   normalization is dimensionless
  normalization *= nuclear_radius * HBARC * HBARC /
                   (F_PI * F_PI);  // now the normalization is dimensionless

  // Making the units work out. In the future, this all should be done
  // consistently with the interaction
  //   double Ctilde = -0.4 / (fpi*fpi);
  //   double C1tilde = 2.0;  // from fitting LO scattering at R0=0.5  (see
  //   Cirigliano et al. PRL 120 202001 ) double C1 =
  //   pow(M_NUCLEON*Ctilde/4/M_PI, 2) * C1tilde;
  ////   double g_nuNN = C1;
  double g_nuNN = 1;
  normalization *= -2 * g_nuNN;

  // std::cout << "Constructing normalization from " << pow( sqrt(3.14159) * R0,
  // -3 ) << " * " << nuclear_radius << " * " << HBARC*HBARC/(fpi*fpi) << " * -2
  // = " << normalization << std::endl;

  //   std::vector<double> rgrid;
  //   for (double r=0; r<10.1; r+=0.1) rgrid.push_back(r);

  //   std::vector<double> rgrid = { 0.10000 ,0.20000 ,0.30000 ,0.40000 ,0.50000
  //   ,0.60000 ,
  //                                 0.70000 ,0.80000 ,0.90000 ,1.00000 ,1.50000
  //                                 ,2.00000 , 2.50000 ,3.00000 ,3.50000
  //                                 ,4.00000 ,4.50000 ,5.00000 , 5.50000
  //                                 ,6.00000 ,6.50000 , 7.00000 ,7.50000
  //                                 ,8.00000 };
  ...
  for (auto channel : M0nuCT.TwoBody.MatEl)
    braketchannels.push_back(channel.first);
  ...
  for (int ch = 0; ch < nchan; ++ch) {
    ...
    for (int ibra = 0; ibra < nbras; ++ibra) {
      ...
      for (int iket = 0; iket < nkets; ++iket) {
        ...
        double mcont = 0;
        //            bool verbose = false;
        //            if (J==0 and la==3 and lb==3 and lc==3 and ld==3 and
        //            na+nb+nc+nd==0 and oa.j2==7 and ob.j2==7 and oc.j2==7 and
        //            od.j2==7) verbose = true; if (verbose) std::cout <<
        //            "osc_b, R0, sigma = " << oscillator_b << " " << R0 << " "
        //            << sigma << "  nuc Radius, norm = " << nuclear_radius << "
        //            " << normalization  << std::endl; std::vector<double>
        //            psirel( rgrid.size(), 0);
        // Transform to LS coupling using 9j coefficients
        for (int Lab = std::abs(la - lb); Lab <= la + lb; ++Lab) {
          for (int Sab = 0; Sab <= 1; ++Sab) {
            ...
            double njcd =
                AngMom::NormNineJ(lc, sc, jc, ld, sd, jd, Lcd, Scd, J);
            if (std::abs(njcd) < 1e-7) continue;
            //                if (verbose) std::cout << "L S = " << Lab << " "
            //                << Sab << "   norm nine-j = " << njab << " , " <<
            //                njcd << std::endl;
            // Next, transform to rel / com coordinates with Moshinsky
            // tranformation
            for (int N_ab = 0; N_ab <= fab / 2; ++N_ab)  // N_ab = CoM n for a,b
            {
                   ...
                   ++Lam_ab)  // Lam_ab = CoM l for a,b
              {
                     ...
                     lam_ab += 2)  // lam_ab = relative l for a,b
                {
                  ...
                  // factor to account for antisymmetrization
                  //                       int asymm_factor =
                  //                       (std::abs(bra.op->tz2+ket.op->tz2) +
                  //                       std::abs(bra.op->tz2+ket.oq->tz2)*modelspace.phase(
                  //                       lam_ab + Sab ))/ 2;
                  // matrix elements are < pp | M | nn >, so we need (-1)(lam +
                  // S) to be positive
                  int asymm_factor =
                      (1 + 1 * modelspace.phase(lam_ab + Sab)) / 2;
                  if (asymm_factor == 0) continue;
                  ...
                  double rad_int =
                      RadialIntegral_Gauss(n_ab, lam_ab, n_cd, lam_cd, sigma);

                  mcont += prefactor * rad_int;
                  //                       if (verbose) std::cout << "   Nab
                  //                       Lamab nab lamab = " << N_ab << " " <<
                  //                       Lam_ab << " " << n_ab << " " <<
                  //                       lam_ab
                  //                                              << "  Ncd
                  //                                              Lamcd ncd
                  ...
                  //                      if (verbose)
                  //                      {
                  //                        for ( size_t i=0; i<rgrid.size();
                  //                        i++ )
                  //                        {
                  //                          psirel[i] += prefactor *
                  //                          pow(2,-1.5)* HO_density(n_ab,
                  //                          lam_ab, modelspace.GetHbarOmega(),
                  //                          rgrid[i] /sqrt(2) );
                  //
                  //                        }
                  //                      }
             ...
             //              {
             //                std::cout << rgrid[i] << "   " << psirel[i] <<
             //                std::endl;
             //              }
             //            }

        mcont *= normalization / sqrt((1.0 + bra.delta_pq()) *
                                      (1.0 + ket.delta_pq()));  // normalize
        //            if (verbose) std::cout << " with normalization " <<
        //            normalization << " , setting matrix element to " << mcont
        //            << std::endl;
...
// This was written with the deuteron in mind. Not sure if it will be useful for
// other systems.
        ...
        for (int Lab = std::abs(la - lb); Lab <= la + lb; ++Lab) {
          for (int Sab = 0; Sab <= 1; ++Sab) {
            ...
            for (int N_ab = 0; N_ab <= fab / 2; ++N_ab)  // N_ab = CoM n for a,b
            {
              ...
              {
                int Lam_cd =
                    Lam_ab;  // tcm and trel conserve lam and Lam, ie relative
                             // and com orbital angular momentum
                for (int lam_ab = (fab - 2 * N_ab - Lam_ab) % 2;
                     lam_ab <= (fab - 2 * N_ab - Lam_ab);
                     lam_ab += 2)  // lam_ab = relative l for a,b
...
/// Without this modification, it seems that the triplet channel does not have
/// enough repulsion to support against collapse, which makes the potential not
/// terribly useful for finite nuclei. This is mostly useful for benchmarking
/// without needing large input files.
///
...
///  e1hf = 177.4709518              e1hf = 132.7170792          e1hf =
///  111.4959623 e2hf = -102.1762390             e2hf = -138.2451400 e2hf =
///  -210.3298042 e3hf = 0.0000000                e3hf = 0.0000000 e3hf =
///  0.0000000 EHF = 75.2947127                EHF  = -5.5280608           EHF =
///  -98.8338419 EIMSRG = -10.047908             EIMSRG = -69.170313 EIMSRG =
///  -144.9899081 Rp2HF = 9.5591609               Rp2HF = 15.1991899 Rp2HF
///  =  20.8748671 Rp2IMSRG = 9.362856             Rp2IMSRG = 14.399832 Rp2IMSRG
///  = 21.353270
...
// We just reuse the Minnesota potential code and set the singlet and triplet
// strengths to zero
Operator GaussianPotential(ModelSpace& modelspace, double sigma) {
  double VR = 1.0;
  ////   double VT = -178. ;
  //   double VT = -178. * 0.2; // scaled to make things not crazy for finite
  //   nuclei double VS = -91.85 ;
...
// A bare delta function of the relative coordinate (effectively regulated by
// the finite oscillator basis). The delta is a 1D delta of the relative
// coordinate, as defined by Moshinsky: r = 1/sqrt(2) |r1-r2|. To convert this
// to the usual definition, we have delta(|r1-r2|) = 1/sqrt(2) delta(r)
// Evaluating the diagonal matrix element between two 0s states, we get
// < 0s 0s | delta(r) | 0s 0s> = 4 / [sqrt(pi) b^3], where b is the oscillator
// length.
Operator BareDelta(ModelSpace& modelspace) {
  ...
  // it's a delta, so we only need the wave function evaluated at r=0. pre-store
  // those
  ...
  for (int ch = 0; ch < nchan; ++ch) {
    ...
    for (int ibra = 0; ibra < nkets; ++ibra) {
      ...
      for (int iket = ibra; iket < nkets; iket++) {
        ...
        for (int Lab = std::abs(la - lb); Lab <= la + lb; ++Lab) {
          if (Lab % 2 != fab % 2)
            continue;  // lam=0, so parity needs to come from COM
          for (int Sab = 0; Sab <= 1; ++Sab) {
            if (std::abs(Lab - Sab) > J or Lab + Sab < J) continue;
            ...
            int lam_cd =
                lam_ab;  // radial delta conserves orbital angular momentum
            ...
            // Next, transform to rel / com coordinates with Moshinsky
            // tranformation
            for (int N_ab = 0; N_ab <= (fab - Lam_ab) / 2;
                 ++N_ab)  // N_ab = CoM n for a,b
            {
              int n_ab = (fab - 2 * N_ab - Lam_ab - lam_ab) /
                         2;  // n_ab is determined by energy conservation
...
///
/// A single matrix element of the Minnesota potential. See more details above
/// MinnesotaPotential
double MinnesotaMatEl(ModelSpace& modelspace, Ket& bra, Ket& ket, int J,
  ...
  ////   double VT = -178. ;
  //   double VT = -178. * 0.2; // scaled to make things not crazy for finite
  //   nuclei double VS = -91.85 ; double kR = 1.487 * oscillator_b2; // make
  //   things dimensionless double kT = 0.639 * oscillator_b2; double kS = 0.465
  //   * oscillator_b2;
  double VR = params[0];
  double VT = params[1];
  double VS = params[2];
  ...
  //   if (std::abs(fab-fcd)>2) return 0; // p1*p2 only connects kets with delta
  //   N = 0,1
  ...
  for (int Lab = std::abs(la - lb); Lab <= la + lb; ++Lab) {
    for (int Sab = 0; Sab <= 1; ++Sab) {
      ...
      //       if ( oa.tz2 != ob.tz2) isospin_factor = 0.5 * (oa.tz2 * oc.tz2);
      //       // <pn|V|pn> = 1/2 (V(T=1) + V(T=0)).  <pn|V|np> = -<pn|V|pn>
      if (std::abs(Lab - Sab) > J or Lab + Sab < J) continue;
      ...
      for (int N_ab = 0; N_ab <= fab / 2; ++N_ab)  // N_ab = CoM n for a,b
      {
             ...
             ++Lam_ab)  // Lam_ab = CoM l for a,b
        {
               ...
               lam_ab += 2)  // lam_ab = relative l for a,b
          {
            ...
            // factor to account for antisymmetrization. I sure wish this were
            // more transparent...
            //  antisymmetrized matrix elements: V = <ab|V|cd> - <ab|V|dc>
            //  here, we've gone to LS, coupling in CM/relative coordinates
            //  so exchange gives us a phase factor and we have V = <ab|V|cd> +
            //  (-1)**(Lcd+Scd) <ab|V|dc> case pp,nn -> 1 + (-1)**(L+S) pnpn ->
            //  1 + 0 pnnp -> 0 + (-1)**(L+S)
            int asymm_factor = (std::abs(bra.op->tz2 + ket.op->tz2) +
                                std::abs(bra.op->tz2 + ket.oq->tz2) *
                                    modelspace.phase(lam_ab + Sab)) /
            ...
            for (int N_cd = N_ab; N_cd <= N_ab; ++N_cd)  // N_cd = CoM n for c,d
            {
              ...
              for (int p = pmin; p <= pmax; p++) {
                double Bp = TalmiB(n_ab, lam_ab, n_cd, lam_cd,
                                   p);  // It's probably inefficient doing this
                                        // in the inner loop, but oh well...
                double Ip = VR / pow(1.0 + kR,
                                     p + 1.5);  // Talmi integral of a Gaussian
                if (Sab == 1)
                  Ip += VT / pow(1.0 + kT,
                                 p + 1.5);  // Triplet short-range potential
                else
                  Ip += VS / pow(1.0 + kS,
                                 p + 1.5);  // Singlet short-range potential
                vrel += Bp * Ip;
              }

              // for debugging
              //                if ( (n_ab==n_cd)  and (lam_ab==lam_cd)  and
              //                (N_ab==N_cd)  and (Lam_ab==Lam_cd) and
              //                (Sab==Scd) and (Lab==Lcd) )  vrel =1; if (
              //                (n_ab==n_cd) and  (N_ab==N_cd)  )  vrel =1; if (
              //                true )  vrel =1;
              Vminn += vrel * njab * njcd * mosh_ab * mosh_cd * asymm_factor;

              //                if ( (J==0) and ((bra.op->l+bra.oq->l)%2==0) and
              //                ((bra.op->tz2+bra.oq->tz2)==-2) )
              //                {
              //                   std::cout << "  abcd << " << bra.p << " " <<
              //                   bra.q << " " << ket.p << " " << ket.q
              //                             << "  nab lab  ncd lcd  " << n_ab
              //                             << " " << lam_ab << " " << n_cd <<
              //                             " " << lam_cd
              //                             << "  Nab Lab  Ncd Lcd  " << N_ab
              //                             << " " << Lam_ab << " " << N_cd <<
...
// Serber-type potential V = f(r) [ A + B sig*sig + C tau*tau + D
// (sig*sig)(tau*tau) ] with f(r) = V_0 exp[-r^2/mu^2] See Suhonen section 8.1.4
Operator SerberTypePotential(ModelSpace& modelspace, double V0, double mu,
...
double SerberMatEl(ModelSpace& modelspace, Ket& bra, Ket& ket, int J,
                   const std::array<double, 6>& params) {
  double oscillator_b2 =
      (HBARC * HBARC / M_NUCLEON / modelspace.GetHbarOmega());
  double V0 = params[0];
      ...
      for (int N_ab = 0; N_ab <= fab / 2; ++N_ab)  // N_ab = CoM n for a,b
      {
             ...
             ++Lam_ab)  // Lam_ab = CoM l for a,b
        {
               ...
               lam_ab += 2)  // lam_ab = relative l for a,b
          {
            ...
            //  so exchange gives us a phase factor and we have V = <ab|V|cd> +
            //  (-1)**(Lcd+Scd) <ab|V|dc> case pp,nn -> 1 + (-1)**(L+S) pnpn ->
            //  1 + 0 pnnp -> 0 + (-1)**(L+S) This is achieved in a one-liner (
            //  |tza+tzc| + |tza+tzd|*(-1)**(lab +Sab)  ), which gives either 1
            //  or 0. The /2 is because tz2 is 2*tz.
            int asymm_factor = (std::abs(bra.op->tz2 + ket.op->tz2) +
                                std::abs(bra.op->tz2 + ket.oq->tz2) *
                                    modelspace.phase(lam_ab + Sab)) /
                               2;
            ...
            int tab =
                (Sab + lam_ab + 1) % 2;  // e.g. deuteron has S=1,L=0,T=0, S+L+T
                                         // must be odd, so T = (L+S+1)%2
            if (tab * 2 < std::abs(oa.tz2 + ob.tz2))
              continue;  // If T < Tz, then this can't contribute.
                 ...
                 ++N_cd)  // N_cd = CoM n for c,d
            {
              ...
              for (int p = pmin; p <= pmax; p++) {
                double Bp = TalmiB(n_ab, lam_ab, n_cd, lam_cd,
                                   p);  // It's probably inefficient doing this
                                        // in the inner loop, but oh well...
                double Ip = 1.0 / pow(1.0 + kR,
                                      p + 1.5);  // Talmi integral of a Gaussian
                RadialInt += Bp * Ip;
              }
              vrel = RadialInt * V0 *
                     (A + B * sig_dot_sig + C * tau_dot_tau +
                      D * sig_dot_sig * tau_dot_tau);
  ...
  for (int ch = 0; ch < nchan; ++ch) {
    ...
    for (int ibra = 0; ibra < nkets; ++ibra) {
      ...
      for (int iket = ibra; iket < nkets; iket++) {
        ...
        //       << "   Kabcd " << Kabcd << std::endl;
        double AT = 1;
        Kabcd = -1. / 4 * AT * AngMom::phase(na + nb + nc + nd);

        double threej0ab =
            AngMom::ThreeJ(0.5 * j2a, 0.5 * j2b, J, 0.5, -0.5, 0);
        double threej1ab =
            AngMom::ThreeJ(0.5 * j2a, 0.5 * j2b, J, 0.5, 0.5, -1);
        double threej0cd =
            AngMom::ThreeJ(0.5 * j2c, 0.5 * j2d, J, 0.5, -0.5, 0);
        double threej1cd =
            AngMom::ThreeJ(0.5 * j2c, 0.5 * j2d, J, 0.5, 0.5, -1);

        double threej0dc =
            AngMom::ThreeJ(0.5 * j2d, 0.5 * j2c, J, 0.5, -0.5, 0);
        double threej1dc =
            AngMom::ThreeJ(0.5 * j2d, 0.5 * j2c, J, 0.5, 0.5, -1);

        double hatfactor = sqrt((j2a + 1) * (j2b + 1) * (j2c + 1) * (j2d + 1));

        // Factor of 2 relative to Suhonen (8.65) because we just enforce parity
        // conservation
        double Aabcd = 2 * Kabcd * hatfactor *
                       (threej1ab * threej1cd -
                        AngMom::phase((2 * la + 2 * lc + j2b + j2d) / 2) *
                            threej0ab * threej0cd);
        double Aabdc = 2 * Kabcd * hatfactor *
                       (threej1ab * threej1dc -
                        AngMom::phase((2 * la + 2 * ld + j2b + j2c) / 2) *
                            threej0ab * threej0dc);
        ...
        {
          vsdi -=
              AngMom::phase((j2c + j2d + 2 * J) / 2) * Aabdc;  // Suhonen (8.55)
        } else if (bra.op->tz2 != ket.op->tz2)  // if we have pnnp or nppn
        {
          vsdi = AngMom::phase((j2c + j2d + 2 * J) / 2 + 1) *
                 Aabdc;  // Suhonen (8.56
        }
...
Operator EKKShift(Operator& Hin, int Nlower, int Nupper) {
  ...
  std::cout << "In EKKShift, elower, eupper, emid = " << elower << " , "
            << eupper << " , " << emid << std::endl;
  return EKKShift;
}
...
/// Embeds the one-body operator of op1 in the two-body part, using mass number
/// A in the embedding. Note that the embedded operator is added to the two-body
/// part, rather than overwriting. The one-body part is left as-is.
void Embed1BodyIn2Body(Operator& op1, int A) {
  if (A < 2) {
    std::cout << "Embed1BodyIn2Body: A = " << A
              << ". You clearly didn't mean to do that..." << std::endl;
    return;
  }
  ...
  for (auto& itmat : op1.TwoBody.MatEl) {
    ...
    for (index_t ibra = 0; ibra < nbras; ++ibra) {
      ...
      for (index_t iket = 0; iket < nkets; ++iket) {
        ...
        index_t k = ket.p;
        index_t l = ket.q;
        double embedded_tbme =
            GetEmbeddedTBME(op1, i, j, k, l, Jbra, Jket, Lambda) / (A - 1.0);
...
/// Returns a normalized TBME formed by embedding the one body part of op1 in a
/// two body operator. Assumes A=2 in the formula. For other values of A, divide
/// by (A-1).
double GetEmbeddedTBME(Operator& op1, index_t i, index_t j, index_t k,
                       index_t l, int Jbra, int Jket, int Lambda) {
  ...
  {
    if (j == l)
      embedded_tbme += OB(i, k) * modelspace->phase(ji + jj + Jket) *
                       AngMom::SixJ(Jbra, Jket, Lambda, jk, ji, jj);
    if (i == k)
      embedded_tbme += OB(j, l) * modelspace->phase(jk + jl - Jbra) *
                       AngMom::SixJ(Jbra, Jket, Lambda, jl, jj, ji);
    if (j == k)
      embedded_tbme -= OB(i, l) * modelspace->phase(ji + jj + jk + jl) *
                       AngMom::SixJ(Jbra, Jket, Lambda, jl, ji, jj);
    if (i == l)
      embedded_tbme -= OB(j, k) * modelspace->phase(Jket - Jbra) *
                       AngMom::SixJ(Jbra, Jket, Lambda, jk, jj, ji);
    embedded_tbme *=
        sqrt((2 * Jbra + 1) * (2 * Jket + 1)) * modelspace->phase(Lambda);
  }
...
//  double FCcoefFunction(int n1, int l1, double hw1, int n2, int l2, double
//  hw2, double r)
...
double FrequencyConversionCoeff(int n1, int l1, double hw1, int n2, int l2,
                                double hw2) {
  double parameters[6] = {(double)n1, (double)l1, hw1,
                          (double)n2, (double)l2, hw2};
  gsl_function F;
  ...
  gsl_integration_qagiu(&F, r0, epsabs, epsrel, limit, workspace, &result,
                        &abserr);
...
void CommutatorTest(Operator& X, Operator& Y) {
  ...
  if ((X.IsHermitian() and Y.IsHermitian()) or
    ...
    Zscalar.SetAntiHermitian();
  if ((X.IsHermitian() and Y.IsAntiHermitian()) or
      (X.IsAntiHermitian() and Y.IsHermitian()))
    Zscalar.SetHermitian();
  Zscalar.Erase();
  ...
  Ztensor.Symmetrize();
  UnReduce(Ztensor);
  std::cout << "comm111 norm = " << Zscalar.OneBodyNorm() << " "
            << Zscalar.TwoBodyNorm() << ",   " << Ztensor.OneBodyNorm() << " "
            << Ztensor.TwoBodyNorm() << std::endl;
  Zscalar -= Ztensor;
  std::cout << "comm111 diff = " << Zscalar.OneBodyNorm() << " "
            << Zscalar.TwoBodyNorm() << std::endl;
  ...
  Ztensor.Symmetrize();
  UnReduce(Ztensor);
  std::cout << "comm121 norm = " << Zscalar.OneBodyNorm() << " "
            << Zscalar.TwoBodyNorm() << ",   " << Ztensor.OneBodyNorm() << " "
            << Ztensor.TwoBodyNorm() << std::endl;
  Zscalar -= Ztensor;
  std::cout << "comm121 diff = " << Zscalar.OneBodyNorm() << " "
            << Zscalar.TwoBodyNorm() << std::endl;
  ...
  Ztensor.Symmetrize();
  UnReduce(Ztensor);
  std::cout << "comm122 norm = " << Zscalar.OneBodyNorm() << " "
            << Zscalar.TwoBodyNorm() << ",   " << Ztensor.OneBodyNorm() << " "
            << Ztensor.TwoBodyNorm() << std::endl;
  Zscalar -= Ztensor;
  std::cout << "comm122 diff = " << Zscalar.OneBodyNorm() << " "
            << Zscalar.TwoBodyNorm() << std::endl;
  ...
  Ztensor.Symmetrize();
  UnReduce(Ztensor);
  std::cout << "comm222_pp_hh_221 norm = " << Zscalar.OneBodyNorm() << " "
            << Zscalar.TwoBodyNorm() << ",   " << Ztensor.OneBodyNorm() << " "
            << Ztensor.TwoBodyNorm() << std::endl;
  Zscalar -= Ztensor;
  std::cout << "comm222_pp_hh_221 diff = " << Zscalar.OneBodyNorm() << " "
            << Zscalar.TwoBodyNorm() << std::endl;
  ...
  Ztensor.Symmetrize();
  UnReduce(Ztensor);
  std::cout << "comm222_ph norm = " << Zscalar.OneBodyNorm() << " "
            << Zscalar.TwoBodyNorm() << ",   " << Ztensor.OneBodyNorm() << " "
            << Ztensor.TwoBodyNorm() << std::endl;
  Zscalar -= Ztensor;
  std::cout << "comm222_ph diff = " << Zscalar.OneBodyNorm() << " "
            << Zscalar.TwoBodyNorm() << std::endl;
}
