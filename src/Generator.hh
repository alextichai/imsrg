...
class Generator {
 ...
 public:
  ...
  void ConstructGenerator_SingleRef(
      std::function<double(double, double)>& etafunc);
  void ConstructGenerator_SingleRef_3body(
      std::function<double(double, double)>& etafunc);
  ...
  void ConstructGenerator_ShellModel_3body(
      std::function<double(double, double)>& eta_func);
  ...
  void ConstructGenerator_ShellModel_NpNh(
      std::function<double(double, double)>& eta_func);
