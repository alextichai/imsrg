...
Operator Ms(ModelSpace&, std::string IsoSV, int J, int L,
            double q);  // helper function
Operator Mg(ModelSpace&, std::string IsoSV, int J, int L,
            double q);  // helper function
...
Operator Omegat(ModelSpace&, std::string IsoSV, int J,
                double q);  // Not implemented
